...
public class OpportunityManagement_PageObjectModel {
	...
	//************************************************** CRMOpportunityFilter  ********************************************
		...
		@FindBy(xpath = "//mat-list-item[@mattooltipclass='custom-tooltip-style']//span[text()='Amount']")
		WebElement Amount_DND;
		@FindBy(xpath = "//mat-list-item[@mattooltipclass='custom-tooltip-style']//span[text()='Created Date']")
		...
		public void RightClickOnOpportunityRouter() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(OpportunityRouter).contextClick(OpportunityRouter).build()
			.perform();
		}
		...
		public void RightClickOnCRMOpportunityFilter() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(CRMOpportunityFilter).contextClick(CRMOpportunityFilter).build()
			.perform();
		}
		...
		public void RightClickOnOpportunityRoutingTerritory() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(OpportunityRoutingTerritory).contextClick(OpportunityRoutingTerritory).build()
			.perform();
		}
