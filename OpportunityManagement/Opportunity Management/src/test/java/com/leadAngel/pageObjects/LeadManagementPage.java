...
//---------------------------WAIT CONDITION----------------------//
	 ...
	 public void RightClickonWaitCondition() {
		 new WebDriverWait(ldriver, Duration.ofSeconds(25))
		 .until(ExpectedConditions.elementToBeClickable(ClickAgainWaitCondition));
		 Actions actions = new Actions(ldriver);
		 actions.moveToElement(ClickAgainWaitCondition).contextClick(ClickAgainWaitCondition).build().perform();
	 }
