...
public class LeadProcessingWithoutRouting_FlowChartPage {
	...
	WebElement ClickOnOtherAmountOptionDetailsPage;
	@FindBy(xpath = "//span[text()='Other Latitude']")
	...
	@FindBy(xpath = "//span[text()='If no one is available, hold the opportunity till someone is available ']//..//span[@class='mat-checkbox-inner-container']")
	WebElement ClickIfNoOneIsAvailableHoldTheOpportunityCheckBox;
	
	
	@FindBy(xpath = "//div[contains(text(),' Opportunity Filter ')]")
	WebElement OpportunityFilterDND;
	@FindBy(xpath = "//span[text()='Amount']")
	WebElement SelectOtherAmountForUpdateDataValue;
	
	
	@FindBy(xpath = "//span[text()='Opportunity']")
	WebElement SelectOpportunityInObjectDropDownUpdateDataValue;
	
	@FindBy(xpath = "//span[text()='Opportunity Owner']")
	WebElement SelectOpportunityOwnerInObjectDropDownUpdateDataValue;
	...
	public void SelectOpportunityOwnerInObjectDropDownUpdateDataValue() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectOpportunityOwnerInObjectDropDownUpdateDataValue));
		SelectOpportunityOwnerInObjectDropDownUpdateDataValue.click();
	}

	public void SelectOpportunityInObjectDropDownUpdateDataValue() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectOpportunityInObjectDropDownUpdateDataValue));
		SelectOpportunityInObjectDropDownUpdateDataValue.click();
	}
	public void SelectOtherAmountForUpdateDataValue() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectOtherAmountForUpdateDataValue));
		SelectOtherAmountForUpdateDataValue.click();
	}
	
	
	public void ClickOnOtherAmountOptionDetailsPage() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnOtherAmountOptionDetailsPage));
		ClickOnOtherAmountOptionDetailsPage.click();
	}
	...
	public void ClickIfNoOneIsAvailableHoldTheOpportunityCheckBox() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickIfNoOneIsAvailableHoldTheOpportunityCheckBox));
		ClickIfNoOneIsAvailableHoldTheOpportunityCheckBox.click();
	}
	...
	@FindBy(xpath = "//span[text()='Amount']")
	WebElement ClickOnAmountOptionForAddDataUpdate;
	@FindBy(xpath = "//span[text()='Deleted']")
	WebElement ClickOnDeletedOptionForAddDataUpdate;
	@FindBy(xpath = "//span[text()='Description']")
	WebElement ClickOnDescriptionOptionForAddDataUpdate;
	...
	WebElement DescriptionDropDownForAddDataUpdateButton;
	...
	public void DescriptionDropDownForAddDataUpdateButton(){
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(DescriptionDropDownForAddDataUpdateButton));
		DescriptionDropDownForAddDataUpdateButton.click(); 
	}
	...
	public void ClickOnAmountOptionForAddDataUpdate() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnAmountOptionForAddDataUpdate));
		ClickOnAmountOptionForAddDataUpdate.click();
	}
	...
	public void ClickOnDescriptionOptionForAddDataUpdate() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnDescriptionOptionForAddDataUpdate));
		ClickOnDescriptionOptionForAddDataUpdate.click();
	}
	...
	public void OpportunityFilterDND() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(OpportunityFilterDND));
		Actions actions = new Actions(ldriver);
		actions.moveToElement(OpportunityFilterDND)
        .pause(Duration.ofSeconds(1))
        .clickAndHold(OpportunityFilterDND)
        .pause(Duration.ofSeconds(1))
        .moveByOffset(-480,95) 
        .moveByOffset(-480,95)
        .pause(Duration.ofSeconds(1))
