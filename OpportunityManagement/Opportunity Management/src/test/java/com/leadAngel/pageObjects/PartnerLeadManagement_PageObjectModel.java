...
public class PartnerLeadManagement_PageObjectModel {
	...
	//************************************************** Partner Team ********************************************
		...
		public void RightClickOnPartnerLeadRouter() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(PartnerLeadRouter).click(PartnerLeadRouter).contextClick(PartnerLeadRouter).build()
			.perform();
		}
		...
		public void RightClickOnPartnerTeam() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(PartnerTeam).click(PartnerTeam).contextClick(PartnerTeam).build()
			.perform();
		}
