...
public class CRM_Lead_FilterPage {
	...
	@FindBy(xpath = "//label[text()='First Name']/..//select[@name='seldropDown']")
	WebElement ClickDropDownFirstName;
	@FindBy(xpath = "//label[text()='Opportunity ID']/..//select[@name='seldropDown']")
	WebElement ClickDropDownOpportunityID;
	...
	@FindBy(xpath = "//div[@class='form-group pt-3 row']//label[text()='Opportunity ID']//parent::div//input[@type='text']")
	WebElement OpportunityIDContainsInput;
	@FindBy(xpath = "(//label[text()='Converted']/..//select[@name='seldropDown'])[1]")
	WebElement ClickDropDownConvertedbox1;

	@FindBy(xpath = "(//label[text()='Converted']/..//select[@name='seldropDown'])[2]")
	WebElement ClickDropDownConvertedbox2;

	@FindBy(xpath="//button[(text()=' Smart Lead Attributes ')]")
	WebElement  SmartLeadAttributes ;

	@FindBy(xpath = "//button[text()=' Smart Lead Attributes ']//..//mat-list-item[contains(@id,'State/Province')]")
	WebElement StateProvinceDND;

	@FindBy(xpath="//label[text()='State/Province']//..//mat-icon[text()='add_box']")
	WebElement AddbtnForStateProvince;
	...
	public void ClickDropDownOpportunityID() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownOpportunityID));
		ClickDropDownOpportunityID.click();
	}
	public void ClickDropDownFirstName() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownFirstName));
		ClickDropDownFirstName.click();
	}

	public void FirstNameContainsInput() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(FirstNameContainsInput));
		FirstNameContainsInput.sendKeys("Testing With Automation!!");
	}
	public void OpportunityIDContainsInput() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(OpportunityIDContainsInput));
		OpportunityIDContainsInput.sendKeys("Testing With Automation!!");
	}
	public void ClickDropDownConvertedbox1() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownConvertedbox1));
		ClickDropDownConvertedbox1.click();
	}


	public void ClickDropDownConvertedbox2() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownConvertedbox2));
		ClickDropDownConvertedbox2.click();
	}


	public void SmartLeadAttributes() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(SmartLeadAttributes));
		SmartLeadAttributes.click();
	}

	public void StateProvinceDND() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(AddField));
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(StateProvinceDND));
		Actions actions = new Actions(ldriver);
		int x = AddField.getLocation().x;
		int y = AddField.getLocation().y;
		actions.moveToElement(StateProvinceDND).pause(Duration.ofSeconds(0)).clickAndHold(StateProvinceDND)
		.pause(Duration.ofSeconds(0))
		// .moveByOffset(x, y)
		.moveToElement(AddField).moveByOffset(x, y).pause(Duration.ofSeconds(0)).release().build().perform();
	}
	...
	public void AddbtnForStateProvince() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForStateProvince));
		AddbtnForStateProvince.click();
	}

	//*************************************************** Sanity test cases X path ***************************************************	
		@FindBy(xpath="//mat-list-item[contains(@id,'Account Name')]")
		WebElement AccountName;
		@FindBy(xpath = "//label[text()='Account Name']/..//select[@name='seldropDown']")
		WebElement ClickDropDownAccountName;

		@FindBy(xpath = "//div[@class='form-group pt-3 row']//label[text()='Account Name']//parent::div//input[@type='text']")
		WebElement AccountNameContainsInputforSanity;



		@FindBy(xpath = "//mat-list-item[contains(@id,'Billing Longitude')]")
		WebElement BillingLongitude;
		@FindBy(xpath = "//label[text()='Billing Longitude ']/..//select[@name='seldropDown']")
		WebElement ClickDropDownBillingLongitude;
		@FindBy(xpath="//label[text()='Billing Longitude ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForBillingLongitude;
		@FindBy(xpath = "//label[text()='Billing Longitude ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement BillingLongitudeInputBoxForIsGreaterThan;
		@FindBy(xpath = "(//label[text()='Billing Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement BillingLongitudeInputBoxForBetweenBox1;
		@FindBy(xpath = "(//label[text()='Billing Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		WebElement BillingLongitudeInputBoxForBetweenBox2;

		@FindBy(xpath="//mat-list-item//span[text()='Deleted']")
		WebElement Deleted_DND;
		@FindBy(xpath = "(//label[text()='Deleted']/..//select[@name='seldropDown'])[1]")
		WebElement ClickDropDownDeletedbox1;
		@FindBy(xpath = "(//label[text()='Deleted']/..//select[@name='seldropDown'])[2]")
		WebElement ClickDropDownDeletedbox2;

		@FindBy(xpath="//mat-list-item[contains(@id,'First Name')]")
		WebElement FirstNameContactFilter;
		...
		public void ClickDropDownDeletedbox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownDeletedbox2));
			ClickDropDownDeletedbox2.click();
		}
		public void ClickDropDownDeletedbox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownDeletedbox1));
			ClickDropDownDeletedbox1.click();
		}
		public void Deleted_DND() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(Deleted_DND));
			Actions actions = new Actions(ldriver);
			int x = AddField.getLocation().x;
			int y = AddField.getLocation().y;
		...
		public void BillingLongitudeInputBoxForBetweenBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(BillingLongitudeInputBoxForBetweenBox2));
			BillingLongitudeInputBoxForBetweenBox2.sendKeys("89455");
		}
		public void BillingLongitudeInputBoxForBetweenBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(BillingLongitudeInputBoxForBetweenBox1));
			BillingLongitudeInputBoxForBetweenBox1.sendKeys("64785");
		}
		public void BillingLongitudeInputBoxForIsGreaterThan() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(BillingLongitudeInputBoxForIsGreaterThan));
			BillingLongitudeInputBoxForIsGreaterThan.sendKeys("46545218");
		}
		public void AddbtnForBillingLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForBillingLongitude));
			AddbtnForBillingLongitude.click();
		}
		public void ClickDropDownBillingLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownBillingLongitude));
			ClickDropDownBillingLongitude.click();
		}
		public void ClickDropDownAccountName() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownAccountName));
			ClickDropDownAccountName.click();
		}

		public void AccountNameContainsInputforSanity() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AccountNameContainsInputforSanity));
			AccountNameContainsInputforSanity.sendKeys("testing With Automation!!");
		}
		...
		public void BillingLongitude_DND() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(AddField));
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(BillingLongitude));
			Actions actions = new Actions(ldriver);
			int x = AddField.getLocation().x;
			int y = AddField.getLocation().y;
			actions.moveToElement(BillingLongitude).pause(Duration.ofSeconds(0)).clickAndHold(BillingLongitude)
			.pause(Duration.ofSeconds(0))
			.moveToElement(AddField).moveByOffset(x, y).pause(Duration.ofSeconds(0)).release().build().perform();
		}
		...
		public void FirstNameContactFilter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(FirstNameContactFilter));
			Actions actions = new Actions(ldriver);
			int x = AddField.getLocation().x;
			int y = AddField.getLocation().y;
			actions.moveToElement(FirstNameContactFilter).pause(Duration.ofSeconds(0)).clickAndHold(FirstNameContactFilter).pause(Duration.ofSeconds(0))
			// .moveByOffset(x, y)
			.moveToElement(AddField).moveByOffset(x, y).pause(Duration.ofSeconds(0)).release().build().perform();
		}
