...
public class LeadRouterPageObjectModel {
	...
	//*****************************************************Lead Router Flow Chart*****************************************
		...
		WebElement CheckBoxForAssignmentBlockMappedSDR;
...
//		}
		...
		public void CheckBoxForAssignmentBlockMappedSDR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(CheckBoxForAssignmentBlockMappedSDR));
			CheckBoxForAssignmentBlockMappedSDR.click();
		}
...
//		}
	...
	//******************************************************* Restart to Edit *********************************************	
		...
		@FindBy(xpath="(//div[contains(text(),'already used')])[1]")
		WebElement DisplayedAlreadyUsedErrorMessage;
		
		@FindBy(xpath="(//button[@class='mat-focus-indicator mat-icon-button mat-button-base']//mat-icon[text()='check_box'])[1]")
		WebElement DisplayedOpportunityRouterFeederCheckBox;
		@FindBy(xpath = "(//button[@class='mat-focus-indicator mat-icon-button mat-button-base']//mat-icon[text()='check_box'])[1]")
		WebElement ClickOnCheckBoxForOpportunityRouterFeeder;
	
		@FindBy(xpath = "(//i[contains(@class,'LeadRouterStatus-1')])[1]")
		WebElement RightClickonAnyOnOftheActivatedObject;
		
		
		@FindBy(xpath = "//span[text()='AutoTestObject_Rename ']//i[contains(@class,'LeadRouterStatus-1')]")
		WebElement RightClickonActiveRouterRenameAutoTestObject;
		
		
		
		
		public void RightClickonActiveRouterRenameAutoTestObject() {
			new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(RightClickonActiveRouterRenameAutoTestObject));
			Actions actions = new Actions(ldriver);
			actions.moveToElement(RightClickonActiveRouterRenameAutoTestObject).contextClick(RightClickonActiveRouterRenameAutoTestObject).build()
					.perform();
		}
		public void RightClickonAnyOnOftheActivatedObject() {
			new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(RightClickonAnyOnOftheActivatedObject));
			Actions actions = new Actions(ldriver);
			actions.moveToElement(RightClickonAnyOnOftheActivatedObject).contextClick(RightClickonAnyOnOftheActivatedObject).build()
					.perform();
		}
		public boolean DisplayedOpportunityRouterFeederCheckBox() {
			try {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOf(DisplayedOpportunityRouterFeederCheckBox));
				return DisplayedOpportunityRouterFeederCheckBox.isDisplayed();
			} catch (Exception e) {
			return false;
			}
		}
		public void ClickOnCheckBoxForOpportunityRouterFeeder() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnCheckBoxForOpportunityRouterFeeder));
			ClickOnCheckBoxForOpportunityRouterFeeder.click();
		}
		
		public boolean DisplayedAlreadyUsedErrorMessage() {
			try {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOf(DisplayedAlreadyUsedErrorMessage));
				return DisplayedAlreadyUsedErrorMessage.isDisplayed();
			} catch (Exception e) {
			      return false;
			}
		}
	...
	//*****************	
		...
		WebElement ClickOnPartnerLeadRouterFeature;
		
		@FindBy(xpath="//span[text()='Continue Processing ']//..//span[@class='mat-radio-outer-circle']")
		WebElement ClickOnLRContinueProcessingCheckBoxPLR;
		
		@FindBy(xpath="//span[text()='Stop Processing']//..//span[@class='mat-radio-container']")
		WebElement ClickOnStopProcessingCheckBoxPLR;
		...
		public void ClickOnStopProcessingCheckBoxPLR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnStopProcessingCheckBoxPLR));
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ClickOnStopProcessingCheckBoxPLR);
		}
		public void ClickOnLRContinueProcessingCheckBoxPLR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnLRContinueProcessingCheckBoxPLR));
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ClickOnLRContinueProcessingCheckBoxPLR);
		}
		
		public void ClickOnPartnerLeadRouterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnPartnerLeadRouterFeature));
			ClickOnPartnerLeadRouterFeature.click();
		}
		
		
		//*************************************************** Partner Team ******************************************************

		@FindBy(xpath = "//label[text()='Partner Name']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedPartnerNameSelectBoxNgValid;
		@FindBy(xpath = "//label[text()='Partner Name']//..//input[contains(@class,'ng-valid')]")
		 WebElement DisplayedPartnerNameInputBoxNgValid;
		
		
		
		@FindBy(xpath = "//label[text()='Partner ID ']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedPartnerIDSelectBoxBoxNgValid;
		@FindBy(xpath = "//label[text()='Partner ID ']//..//input[contains(@class,'ng-valid')]")
		 WebElement DisplayedPartnerIDInputBoxNgValid;
		
		@FindBy(xpath="//span[text()='Partner Team ']")
		WebElement ClickOnPartnerTeamFeature;
		
		
		public void ClickOnPartnerTeamFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnPartnerTeamFeature));
			ClickOnPartnerTeamFeature.click();
		}
		
		public boolean DisplayedPartnerNameSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedPartnerNameSelectBoxNgValid));
			return DisplayedPartnerNameSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedPartnerNameInputBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedPartnerNameInputBoxNgValid));
			return DisplayedPartnerNameInputBoxNgValid.isDisplayed();
		}

		
		public boolean DisplayedPartnerIDSelectBoxBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedPartnerIDSelectBoxBoxNgValid));
			return DisplayedPartnerIDSelectBoxBoxNgValid.isDisplayed();
		}
		public boolean DisplayedPartnerIDInputBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedPartnerIDInputBoxNgValid));
			return DisplayedPartnerIDInputBoxNgValid.isDisplayed();
		}
		
		
		//*************************************************** Partner Team ******************************************************

		@FindBy(xpath = "(//mat-option/span[contains(text(),'Assign to Partner Team')])[1]")
		WebElement SelectPartnerTeamOption;
		
		
		
		
		
		public void SelectPartnerTeamOption() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectPartnerTeamOption));
			SelectPartnerTeamOption.click();
		}
		
		//*************************************************** Opportunity Router ******************************************************
	
		@FindBy(xpath="//span[text()='Opportunity Router ']")
		WebElement ClickOnOpportunityRouterFeature;

		@FindBy(xpath="//ng-select[@formcontrolname='Value']")
		WebElement ClickOnThirdListBoxdropdownForUpdateDataValueDropDown;

		
		
		
		public void ClickOnThirdListBoxdropdownForUpdateDataValueDropDown() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnThirdListBoxdropdownForUpdateDataValueDropDown));
			ClickOnThirdListBoxdropdownForUpdateDataValueDropDown.click();
		}
		
		public void ClickOnOpportunityRouterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnOpportunityRouterFeature));
			ClickOnOpportunityRouterFeature.click();
		}
		
		//***************************************************Wait Filter Opportunity Module ******************************************************

		@FindBy(xpath = "//label[text()='Opportunity ID']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedOpportunityIDSelectBoxNgValid;
		@FindBy(xpath = "//label[text()='Opportunity ID']//..//input[contains(@class,'ng-valid')]")
		 WebElement DisplayedOpportunityIDInputBoxNgValid;
		
		
		@FindBy(xpath = "//label[text()='Amount ']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedAmountSelectBoxNgValid;
		@FindBy(xpath = "(//label[text()='Amount ']//..//input[contains(@class,'ng-valid')])[1]")
		 WebElement DisplayedAmountInputBoxNgValid1;
		@FindBy(xpath = "(//label[text()='Amount ']//..//input[contains(@class,'ng-valid')])[2]")
		 WebElement DisplayedAmountInputBoxNgValid2;
		
		@FindBy(xpath = "(//label[text()='Deleted']//..//select[contains(@class,'ng-valid')])[1]")
		 WebElement DisplayedDeletedSelectBoxNgValid;
		@FindBy(xpath = "(//label[text()='Deleted']//..//select[contains(@class,'ng-valid')])[2]")
		 WebElement DisplayedDeletedSelectBoxNgValid2;
		
		
		@FindBy(xpath = "//label[text()='CRM Opportunity Filter']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedCRMOpportunityFilterSelectBoxNgValid;
		@FindBy(xpath = "//label[text()='CRM Opportunity Filter']//..//ng-select[contains(@class,'ng-valid')]")
		 WebElement DisplayedCRMOpportunityFilterNgSelectBoxBoxNgValid;
		...
		WebElement ClickOnOpportunityRoutingTerritoryFeature;
		
		
		@FindBy(xpath="(//ng-select[@name='seldropDown'])[1]")
		WebElement AccountListOptionDropdown2;
		
		@FindBy(xpath="(//ng-select[@name='seldropDown'])[2]")
		WebElement CRMAccountFilterOptionDropdown2;
		
		@FindBy(xpath="//mat-list-item[@mattooltipclass='custom-tooltip-style']//span[text()='CRM Opportunity Filter']")
		WebElement CRMOpportunityFilterDND;

		@FindBy(xpath="//span[text()='CRM Opportunity Filter ']")
		WebElement ClickOnCRMOpportunityFilterFilterFeature;
		
		@FindBy(xpath="//span[text()='AutoTestObject']//..//i[contains(@class,'crm-opportunity-filter')]")
		WebElement SelectAutoTestObjectCRMOpportunityFilter;
		...
		public void SelectAutoTestObjectCRMOpportunityFilter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectAutoTestObjectCRMOpportunityFilter));
			SelectAutoTestObjectCRMOpportunityFilter.click();
		}
		public void ClickOnCRMOpportunityFilterFilterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnCRMOpportunityFilterFilterFeature));
			ClickOnCRMOpportunityFilterFilterFeature.click();
		}
		
		public void CRMOpportunityFilterDND() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(CRMOpportunityFilterDND));
			Actions actions = new Actions(ldriver);
			int x = AddField.getLocation().x;
			int y = AddField.getLocation().y;
			actions.moveToElement(CRMOpportunityFilterDND).pause(Duration.ofSeconds(0)).clickAndHold(CRMOpportunityFilterDND).pause(Duration.ofSeconds(1))
			.moveToElement(AddField).moveByOffset(x, y).pause(Duration.ofSeconds(0)).release().build().perform();
		}
		
		public void CRMAccountFilterOptionDropdown2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(CRMAccountFilterOptionDropdown2));
			CRMAccountFilterOptionDropdown2.click();
		}
		
		public void AccountListOptionDropdown2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(AccountListOptionDropdown2));
			AccountListOptionDropdown2.click();
		}
		
		
		
		
		public void ClickOnOpportunityRoutingTerritoryFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnOpportunityRoutingTerritoryFeature));
			ClickOnOpportunityRoutingTerritoryFeature.click();
		}
	
		public void InputForCutomFilter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(InputForCutomFilter));
			InputForCutomFilter.sendKeys("1 and 2 and 3");
		}
		
		public boolean DisplayedCRMOpportunityFilterSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedCRMOpportunityFilterSelectBoxNgValid));
			return DisplayedCRMOpportunityFilterSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedCRMOpportunityFilterNgSelectBoxBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedCRMOpportunityFilterNgSelectBoxBoxNgValid));
			return DisplayedCRMOpportunityFilterNgSelectBoxBoxNgValid.isDisplayed();
		}
		
		
		
		public boolean DisplayedDeletedSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedDeletedSelectBoxNgValid));
			return DisplayedDeletedSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedDeletedSelectBoxNgValid2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedDeletedSelectBoxNgValid2));
			return DisplayedDeletedSelectBoxNgValid2.isDisplayed();
		}
		
		
		
		
		public boolean DisplayedAmountSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedAmountSelectBoxNgValid));
			return DisplayedAmountSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedAmountInputBoxNgValid1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedAmountInputBoxNgValid1));
			return DisplayedAmountInputBoxNgValid1.isDisplayed();
		}
		public boolean DisplayedAmountInputBoxNgValid2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedAmountInputBoxNgValid2));
			return DisplayedAmountInputBoxNgValid2.isDisplayed();
		}
		
		
		public boolean DisplayedOpportunityIDSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedOpportunityIDSelectBoxNgValid));
			return DisplayedOpportunityIDSelectBoxNgValid.isDisplayed();
		}

		public boolean DisplayedOpportunityIDInputBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedOpportunityIDInputBoxNgValid));
			return DisplayedOpportunityIDInputBoxNgValid.isDisplayed();
		}
