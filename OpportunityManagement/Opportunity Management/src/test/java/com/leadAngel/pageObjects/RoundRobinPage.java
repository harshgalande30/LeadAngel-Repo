...
//	}
	...
	public void RightClickonAutoTestObject() {
		...
		@FindBy(xpath = "//label[text()='Longitude ']/..//select[@name='seldropDown']")
		...
		@FindBy(xpath = "//label[text()='Longitude ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement LongitudeInputBoxForIsGreaterThan;
		
		@FindBy(xpath = "(//label[text()='Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement LongitudeInputBoxForBetweenBox1;
		
		@FindBy(xpath = "(//label[text()='Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		...
		@FindBy(xpath = "//label[text()='Amount ']/..//select[@name='seldropDown']")
		WebElement ClickDropDownAmount;
		@FindBy(xpath="//label[text()='Amount ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForAmount;
		@FindBy(xpath = "//label[text()='Amount ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement AmountInputBoxForIsGreaterThan;
		@FindBy(xpath = "(//label[text()='Amount ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement AmountInputBoxForBetweenBox1;
		
		@FindBy(xpath = "(//label[text()='Amount ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		WebElement AmountInputBoxForBetweenBox2;
		@FindBy(xpath = "//button[@type='submit']")
		...
		@FindBy(xpath = "(//button[@type='submit'])[2]")
		WebElement ApproveSubmitbtnForOppRouter;
		
		
		
		
		public void ApproveSubmitbtnForOppRouter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ApproveSubmitbtnForOppRouter));
			//ApproveSubmitbtn.click();
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ApproveSubmitbtnForOppRouter);
		}	
		...
		public void AmountInputBoxForBetweenBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(AmountInputBoxForBetweenBox2));
			AmountInputBoxForBetweenBox2.sendKeys("89455");
		}
		public void AmountInputBoxForBetweenBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(AmountInputBoxForBetweenBox1));
			AmountInputBoxForBetweenBox1.sendKeys("64785");
		}
		public void AmountInputBoxForIsGreaterThan() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(AmountInputBoxForIsGreaterThan));
			AmountInputBoxForIsGreaterThan.sendKeys("46545218");
		}
		public void AddbtnForAmount() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForAmount));
			AddbtnForAmount.click();
		}
		public void ClickDropDownAmount() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownAmount));
			ClickDropDownAmount.click();
		}
