...
public class TC_Sanity_CRMopportunityFilter_OpportunityManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_Sanity_CRMopportunityFilter_OpportunityManagement.class);

	@Test(description = "OpportunityManagement_DataDictionary _Section")
	@Step("OpportunityManagement_DataDictionary_CRMopportunityFilter")
	@Description("OpportunityManagement_DataDictionary_CRMopportunityFilter")

	public void OpportunityManagementTest() throws InterruptedException {
		...
		Thread.sleep(2500);
		try {
			OM.RightClickOnCRMOpportunityFilter();
			Logger.info("Right Click on CRMOpportunityFilter is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Right Click on CRMOpportunityFilter is Failed",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.ClickOnNewObject();
			Logger.info("Click on New CRM Opportunity Filter is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on New CRM Opportunity Filter is Failed",e);
			sa.assertAll();
		}
		...
		if(ae.DisplaySameAEerror() == true) {
			...
			Thread.sleep(4000);
			try {
				OM.CRMOpportunityFilterDropDown();
				Logger.info("Click on CRMOpportunityFilter DropDown is Passed");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Click on CRMOpportunityFilter DropDown is FAILED",e);
				sa.assertAll();
			}
			Thread.sleep(2500);
			try {
			...
			try {
				LMP.ClickOnNewObject();
				Logger.info("Click on New CRMOpportunityFilter is PASSED!!");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Click on New CRMOpportunityFilter is FAILED!!", e);
				sa.assertAll();
			}
			Thread.sleep(3000);
			try {
		...
		try {
			Thread.sleep(2500);
			if( OM.DisplayCRMOpportunityFilterOverview()==true) {
				Thread.sleep(4000);
				Logger.info("Display CRMOpportunityFilter Overview Page");
				Thread.sleep(3500);
				try {
					OM.CRMOpportunityFilterDropDown();
					Logger.info("Click on CRMOpportunityFilter DropDown is Passed");
		...
		Thread.sleep(3500);
		try {
			OM.ClickOnOpportunityAttributes();
			Logger.info("Click on Opportunity Attribute is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Opportunity Attribute is FAILED!!",e);
			sa.assertAll();
		}

		Logger.info("//===================================== DRAG&DROP Opportunity ID ATTRIBUTE =====================================//");
		Thread.sleep(3500);
		try {
			OM.OpportunityID_DND();
			Logger.info("Drag and Drop OpportunityID is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Drag and Drop OpportunityID is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
			LF.ClickDropDownOpportunityID();
			Logger.info("Click on DropDown OpportunityID is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on DropDown OpportunityID is Failed", e);
			sa.assertAll();
		}
		List<WebElement> AllLinksOfFirstName = driver.findElements(By.xpath("//label[text()='Opportunity ID']/..//select//option[text()]"));
		...
		for (int i=1;i<countAboutMe;i++) {
			...
			Thread.sleep(500);
			try {
				if( LR.DisplayedOpportunityIDSelectBoxNgValid()==true) {
			...
			if (getLinkTextFirstName.contains("contains") || getLinkTextFirstName.contains("does not contain")
				...
				Thread.sleep(1500);
				try {
					LF.OpportunityIDContainsInput();
					Logger.info("Input on OpportunityID is PASSED!!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Input on OpportunityID is FAILED!!", e);
					sa.assertAll();
				}	
				Thread.sleep(500);
				try {
					if( LR.DisplayedOpportunityIDInputBoxNgValid()==true) {
		...
		Logger.info("//======================================= DRAG&DROP AMOUNT ATTRIBUTE ==================================//");
		Thread.sleep(3500);
		try {
			OM.Amount_DND();
			Logger.info("Drag and Drop Amount is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Drag and Drop Amount is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			rrp.ClickDropDownAmount();
			Thread.sleep(2500);
			rrp.ClickDropDownAmount();
			Logger.info("Click on DropDown Amount is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on DropDown Amount is Failed", e);
			sa.assertAll();
		}
		List<WebElement> AllLinksOfAmount = driver.findElements(By.xpath("//label[text()='Amount ']/..//select//option[text()]"));
		int countAmount=AllLinksOfAmount.size();
		for (int j =1; j < countAmount; j++) {
			WebElement getLinkAmount = AllLinksOfAmount.get(j);
			String getLinkTextAmount = getLinkAmount.getText();
			Thread.sleep(1500);
			try {
				getLinkAmount.click();
				Logger.info("Select "+getLinkTextAmount+" is Passed");
			} catch (Exception e) {
				sa.assertTrue(false);
				Logger.error("Select "+getLinkTextAmount+" is Failed",e);
				sa.assertAll();
			}
			Thread.sleep(500);
			try {
				if( LR.DisplayedAmountSelectBoxNgValid()==true) {
					Logger.info("Displayed Select Box is not red");
				}
			} catch (Exception e) {
				sa.assertTrue(false);
			...
			if (getLinkTextAmount.contains("is empty")||getLinkTextAmount.contains("is not empty")) {
				continue;
			}
			else if (getLinkTextAmount.contains("in")||getLinkTextAmount.contains("not in")) {
				Thread.sleep(1500);
				try {
					rrp.AddbtnForAmount();
					Logger.info("Click on Add Button is PASSED!!");
				...
				Thread.sleep(500);
				try {
					if( LR.DisplayedAmountInputBoxNgValid1()==true) {
			...
			else if (getLinkTextAmount.contains("is greater than")||getLinkTextAmount.contains("is smaller than") ||
					getLinkTextAmount.contains("is at least")||getLinkTextAmount.contains("is at most")) {
				Thread.sleep(1500);
				try {
					rrp.AmountInputBoxForIsGreaterThan();
					sa.assertTrue(true);
					Logger.info("Input on Amount is PASSED!!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Input on Amount is FAILED!!", e);
					sa.assertAll();
				}
				Thread.sleep(500);
				try {
			...
			else if (getLinkTextAmount.contains("between")) {
				Thread.sleep(1500);
				try {
					rrp.AmountInputBoxForBetweenBox1();
					sa.assertTrue(true);
					Logger.info("Amount Input Box For Between Box1 is PASSED!!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Amount Input Box For Between Box1 is FAILED!!", e);
					sa.assertAll();
				}
				Thread.sleep(500);
				try {
				...
				Thread.sleep(1500);
				try {
					rrp.AmountInputBoxForBetweenBox2();
					sa.assertTrue(true);
					Logger.info("Amount Input Box For Between Box2 is PASSED!!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Amount Input Box For Between Box2 is FAILED!!", e);
					sa.assertAll();
				}
				Thread.sleep(500);
				try {
					if( LR.DisplayedAmountInputBoxNgValid2()==true) {
		...
		for (int k = 1; k <countConverted; k++) {
			...
			Thread.sleep(500);
			try {
				if( LR.DisplayedDeletedSelectBoxNgValid()==true) {
					Logger.info("Displayed Select Box is not red");
				}
			} catch (Exception e) {
				sa.assertTrue(false);
			...
			for (int L = 1; L <countConvertedBox2; L++) {
				...
				try {
					if( LR.DisplayedDeletedSelectBoxNgValid2()==true) {
						Logger.info("Displayed Select Box2 is not red");
					}
				} catch (Exception e) {
					sa.assertTrue(false);
		...
		String UpperCaseOpportinityId=GetText.toUpperCase();
		Logger.info("Get Text: '"+GetText+"'");
		Logger.info("Upper case: '"+UpperCaseOpportinityId+"'");
		Thread.sleep(1500);
		try {

			driver.findElement(By.xpath("//mat-list-item[@mattooltipclass='custom-tooltip-style']//span[contains(translate(text(), 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'), '"+UpperCaseOpportinityId+"')]")).isDisplayed();
		...
		try {
			...
			Logger.info("Click on OpportunityAttribute is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on OpportunityAttribute is FAILED!!",e);
			sa.assertAll();
		}
		//*************************************************************************************************************
		Thread.sleep(2500);
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnCRMOpportunityFilterFilterFeature();
			Logger.info("Click On CRMOpportunityFilterFilter Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on CRMOpportunityFilterFilter Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(5000);
		try {
			if( OM.DisplayCRMOpportunityFilterOverview()==true) {
				Logger.info("Display CRMOpportunityFilterFilter OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display CRMOpportunityFilterFilter OverView Page is Failed", e);
			sa.assertAll();
		}
