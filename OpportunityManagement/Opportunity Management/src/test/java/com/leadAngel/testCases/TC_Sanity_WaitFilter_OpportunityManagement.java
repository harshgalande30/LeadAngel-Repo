...
@Test
public class TC_Sanity_WaitFilter_OpportunityManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_Sanity_WaitFilter_OpportunityManagement.class);
