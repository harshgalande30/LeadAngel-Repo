...
@Test
public class TC_Sanity_WaitCondition_OpportunityManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_Sanity_WaitCondition_OpportunityManagement.class);
