...
@Test
public class TC_CrudOperation_WaitFilter_OpportunityModule extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_CrudOperation_WaitFilter_OpportunityModule.class);
	public void crud_AccountList() throws InterruptedException {
		...
		try {
			...
			Logger.info("Entered AutoTestObjectName is PASSED!!");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Entered AutoTestObjectName is FAILED!!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		try {
			...
			Logger.info("Change Opportunity Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Change Opportunity Option is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			AM.EditEnterAccountID();
			Logger.info("Enter Opportunity is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Enter Opportunitys is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			AM.EditDeleted_Option2();
			Logger.info("Change Deleted Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Change Deleted_Option is FAILED!!",e);
			sa.assertAll();
		}
		Logger.info("//=========================================APPROVE SCENARIO START======================================//");
		Thread.sleep(3500);
