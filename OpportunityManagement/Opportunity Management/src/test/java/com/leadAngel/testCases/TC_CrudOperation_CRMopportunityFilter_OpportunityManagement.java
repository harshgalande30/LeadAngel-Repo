...
public class TC_CrudOperation_CRMopportunityFilter_OpportunityManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_CrudOperation_CRMopportunityFilter_OpportunityManagement.class);
	...
	public void LeadManagementTest() throws InterruptedException {
		...
		try {
			...
			Thread.sleep(2500);
			AM.AccounttId_Option();
			Logger.info("Click on OpportunityId Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on OpportunityId Option is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			AM.EnterAccountID();
			Logger.info("Enter OpportunityID is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Enter OpportunityID is FAILED!!",e);
			sa.assertAll();
		}
		...
		Thread.sleep(3500);
		try {
			LR.SelectAutoTestObjectCRMOpportunityFilter();
		...
		Logger.info("======================================= Go back To CRM OpportunityFilter Object ==================================");
		Thread.sleep(3000);
		try {
			LMP.ClickOnDataDictionary();
			Logger.info("Click on Data Dictionary is Passed");
		...
		try {
			...
			Logger.info("ClickOn Detail button is PASSED!");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("ClickOn Detail button is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(4500);
		try {
		...
		try {
			...
			Logger.info("Change AccounttId Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Change AccounttId Option is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
