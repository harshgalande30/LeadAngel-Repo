...
public class CRM_Lead_FilterPage {
	...
	WebElement AddField; 
	@FindBy(xpath="//i[@class='righticon-STRING']//..//span[text()='First Name']")
	...
	@FindBy(xpath="//i[@class='righticon-NUMBER']//..//span[text()='Annual Revenue']")
...
//		}
	...
	//*************************************************** Sanity test cases X path ***************************************************	
		...
		@FindBy(xpath = "//label[text()='Partner Name']/..//select[@name='seldropDown']")
		WebElement ClickDropDownPartnerName;
		
		@FindBy(xpath="//div[@class='form-group pt-3 row']//label[text()='Partner Name']//parent::div//input[@type='text']")
	    WebElement PartnertNameContainsInput;
		...
		public void ClickDropDownPartnerName() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownPartnerName));
			ClickDropDownPartnerName.click();
		}
		
		public void PartnertNameContainsInput() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(PartnertNameContainsInput));
			PartnertNameContainsInput.sendKeys("testing With Automation!!");
		}
