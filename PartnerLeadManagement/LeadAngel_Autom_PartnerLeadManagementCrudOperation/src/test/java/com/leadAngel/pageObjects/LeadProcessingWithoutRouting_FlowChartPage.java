...
public class LeadProcessingWithoutRouting_FlowChartPage {
	...
	//************************************************************* Sanity Test Cases *****************************************************************
		...
		@FindBy(xpath = "//span[text()='Lead Owner']")
		...
		@FindBy(xpath = "(//mat-select[@role='combobox'])[2]")
		WebElement SelectDropDownForPartnerTeam;
		@FindBy(xpath = "(//span[@class='custom-option-content ng-star-inserted'])[2]")
		WebElement SelectOptionForPartnerTeam;
		@FindBy(xpath = "(//mat-option[@role='option'])[2]")
		WebElement SelectOptionForPartnerRep;
		...
		@FindBy(xpath = "//span[text()='Latitude']")
		WebElement ClickOnLatitudeOptionForAddDataUpdate;
		
		@FindBy(xpath = "//span[text()='Lead ID']")
		WebElement ClickOnLeadIdOptionForAddDataUpdate;
		...
		public void ClickOnLatitudeOptionForAddDataUpdate() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnLatitudeOptionForAddDataUpdate));
			ClickOnLatitudeOptionForAddDataUpdate.click();
		}
		...
		public void ClickOnLeadIdOptionForAddDataUpdate() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnLeadIdOptionForAddDataUpdate));
			ClickOnLeadIdOptionForAddDataUpdate.click();
		}
		...
		public void SelectOptionForPartnerRep() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectOptionForPartnerRep));
			SelectOptionForPartnerRep.click();
		}
		public void SelectOptionForPartnerTeam() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectOptionForPartnerTeam));
			SelectOptionForPartnerTeam.click();
		}
		public void SelectDropDownForPartnerTeam() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectDropDownForPartnerTeam));
			SelectDropDownForPartnerTeam.click();
		}
