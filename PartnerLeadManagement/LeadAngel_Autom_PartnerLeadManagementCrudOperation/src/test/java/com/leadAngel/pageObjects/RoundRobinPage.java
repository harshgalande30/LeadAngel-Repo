...
public class RoundRobinPage {
	...
	@FindBy(xpath = "(//button[@type='submit'])[2]")
	WebElement ApproveSubmitbtnForParnterLead;
	...
	public void ApproveSubmitbtnForParnterLead()
	{
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ApproveSubmitbtnForParnterLead));
		ApproveSubmitbtnForParnterLead.click();	
	}
...
//	}
	...
	public void RightClickonAutoTestObject() {
		...
		@FindBy(xpath = "//label[text()='Partner ID ']/..//select[@name='seldropDown']")
		WebElement ClickDropDownPartnerID;
		...
		@FindBy(xpath="//label[text()='Partner ID ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForPartnerID;
		@FindBy(xpath="//label[text()='Longitude ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForLongitude;
		@FindBy(xpath = "//label[text()='Partner ID ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement PartnerIDInputBoxForIsGreaterThan;
		@FindBy(xpath = "(//label[text()='Partner ID ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement PartnerIDInputBoxForBetweenBox1;
		@FindBy(xpath = "(//label[text()='Partner ID ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		WebElement PartnerIDInputBoxForBetweenBox2;
		
		@FindBy(xpath = "//input[@name='canvassearch']")
		WebElement InputForCutomFilterForPartnerTeam;
		...
		public void InputForCutomFilterForPartnerTeam() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(InputForCutomFilterForPartnerTeam));
			InputForCutomFilterForPartnerTeam.sendKeys("1 and 2");
		}
		...
		public void AddbtnForPartnerID() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForPartnerID));
			AddbtnForPartnerID.click();
		}
		...
		public void ClickDropDownPartnerID() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownPartnerID));
			ClickDropDownPartnerID.click();
		}
		...
		public void PartnerIDInputBoxForIsGreaterThan() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(PartnerIDInputBoxForIsGreaterThan));
			PartnerIDInputBoxForIsGreaterThan.sendKeys("46545218");
		}
		...
		public void PartnerIDInputBoxForBetweenBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(PartnerIDInputBoxForBetweenBox1));
			PartnerIDInputBoxForBetweenBox1.sendKeys("64785");
		}
		...
		public void PartnerIDInputBoxForBetweenBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(PartnerIDInputBoxForBetweenBox2));
			PartnerIDInputBoxForBetweenBox2.sendKeys("89455");
		}
