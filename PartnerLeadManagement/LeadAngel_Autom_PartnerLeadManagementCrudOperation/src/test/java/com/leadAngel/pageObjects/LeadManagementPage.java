...
//-----------------  WAIT FILTER ------------------------------//
	...
	WebElement SelectWaitFilterOption1;
...
//---------------------WAIT CONDITION-----------------------//
	...
	@FindBy(xpath="//ng-select[@bindvalue='ObjectId']")
    WebElement clickOnSelectWaitFilterForPartnerLead;	
...
//---------------------------WAIT CONDITION----------------------//
	 ...
	 public void clickOnSelectWaitFilterForPartnerLead() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(clickOnSelectWaitFilterForPartnerLead));
			clickOnSelectWaitFilterForPartnerLead.click();
 }
	...
	public void WaitFil_DND() {
	 ...
	 public void SelectWaitFilterOption1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(SelectWaitFilterOption1));
			SelectWaitFilterOption1.click();
	}
...
public void FullName_DND() {
 ...
 //*****************************************************Lead Routing Page DropDown********************************************
		 ...
		 @FindBy(xpath = "//span[text()=' Capping Condition ']//..//span[@class='mat-checkbox-inner-container']")
			...
			WebElement DataValueUpdateWhenRoutedToDefaultLeadOwnerDropDownForPartner;
			
			
			
	
			@FindBy(xpath = "(//mat-icon[text()='check_box'])[2]")
			WebElement CheckBoxForDataValueUpdateWhenRoutedToDefaultLeadOwnerPartner;
			...
			public void CheckBoxForDataValueUpdateWhenRoutedToDefaultLeadOwnerPartner() {
				new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(CheckBoxForDataValueUpdateWhenRoutedToDefaultLeadOwnerPartner));
				CheckBoxForDataValueUpdateWhenRoutedToDefaultLeadOwnerPartner.click();
			}
			public void DataValueUpdateWhenRoutedToDefaultLeadOwnerDropDownForPartner() {
				new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(DataValueUpdateWhenRoutedToDefaultLeadOwnerDropDownForPartner));
				DataValueUpdateWhenRoutedToDefaultLeadOwnerDropDownForPartner.click();
			}
