...
@Test
public class TC_CrudOpertaion_PartnerTeam_PartnerLeadManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_CrudOpertaion_PartnerTeam_PartnerLeadManagement.class);
	...
	public void PrtnerLeadManagementTest() throws InterruptedException {
		...
		Logger.info("//================================================PartnerID_DND Operation===============================================");
		Thread.sleep(3500);
		try {
			PLM.PartnerID_DND();
		...
		try {
			PLM.EnterPartnerID();
			Logger.info("Enter PartnerID is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Enter PartnerID is FAILED!!",e);
			sa.assertAll();
		}

		Logger.info("//================================================PartnerName_DND Operation===============================================");
		Thread.sleep(3500);
		try {
			PLM.PartnerName_DND();
		...
		Thread.sleep(2500);
		try {
			PLM.SelectPartnerNameOption();
			Thread.sleep(2500);
			PLM.SelectPartnerNameOption();
			Logger.info("Select PartnerName Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Select PartnerName Option is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			PLM.EnterPartnerNameContainsValue();
			Logger.info("Enter PartnerName Contains Value is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Enter PartnerName Contains Value is FAILED!!",e);
			sa.assertAll();
		}
		...
		Logger.info("//**************************************** Make Use of this Object PartnerLead Router *******************************************");
		Thread.sleep(4000);
		try {
		...
		if(ae.DisplaySameAEerror() == true) {
			...
			try {
				LMP.NameInCrudObject();
				Logger.info("Enter AutTestObject Name is PASSED!!");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Enter AutTestObject Name is FAILED!!!",e);
				sa.assertAll();
			}
			Thread.sleep(3500);
			try {
		...
		Thread.sleep(3500);
		try {
			LR.SelectPartnerTeamOption();
			Logger.info("Select Partner team option In AssignmentBlock is Passed !!");	
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select Partner team option In AssignmentBlock is Failed !!",e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
		...
		Logger.info("//========================  CutomField1_DND =============================");
		Thread.sleep(3500);
		try {
			PLM.EditCutomField1_DND();
			Logger.info("Drag and Drop CutomField1 is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Drag and Drop CutomField1 is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			PLM.EditSelectCutomFiled1Option();
			Thread.sleep(2500);
			PLM.EditSelectCutomFiled1Option();
			Logger.info("Select CutomFiled1 Option is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Select CutomFiled1 Option is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
			PLM.EditClickCutomFiled1AddButton();
			Logger.info("Click CutomFiled1 AddButton is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click CutomFiled1 AddButton is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(3500);
