...
public class BaseClass {
  ...
  //  private final static Logger Logger = org.apache.logging.log4j.LogManager.getLogger(TC_SANITY_SalesTeam_AEtoSDR.class);
    private String roleName;

    @SuppressWarnings("static-access")
    @Parameters({ "browser", "roleName" })
    @BeforeClass
    public void setup(@Optional("chrome") String br, @Optional("admin") String roleName) throws MalformedURLException {
