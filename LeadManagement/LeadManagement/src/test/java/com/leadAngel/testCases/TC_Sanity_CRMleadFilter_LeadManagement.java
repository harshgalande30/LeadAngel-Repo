...
public class TC_Sanity_CRMleadFilter_LeadManagement extends BaseClass{
	private final static Logger Logger = org.apache.logging.log4j.LogManager
			.getLogger(TC_Sanity_CRMleadFilter_LeadManagement.class);
	@Test(description = "LeadManagement_DataDictionary _Section")
	@Step("LeadManagement_DataDictionary_CRM_LeadFilter")
	@Description("LeadManagement_DataDictionary_CRM_LeadFilter")
	...
	public void LeadManagementTest() throws InterruptedException {
		...
		Thread.sleep(2500);
		try {
			LMP.RightClickonCRM_LeadFilter();
			Logger.info("Right Click on CRM Lead Filter is passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Right Click on CRM Lead Filter is failed",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.ClickOnNewObject();
			Logger.info("Click on New CRM Lead Filter is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on New CRM Lead Filter is Failed",e);
			sa.assertAll();
		}
		...
		try {
			...
			Logger.info("Click on Save Button New CRM Lead Filter is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Save Button New CRM Lead Filter is Failed", e);
			sa.assertAll();
		} 
		...
		try {
			Thread.sleep(2500);
			if( LF.DisplayALeadListOverView()==true) {
		...
		for (int j =1; j < countLongitude; j++) {
			...
			if (getLinkTextLongitude.contains("is empty")||getLinkTextLongitude.contains("is not empty")) {
				...
				try {
					...
					rrp.TextAreaLongitudeAlphabet();
					Logger.error("Enter free text Longitude is Failed!!",e);
				}	
				Thread.sleep(1500);
				try {
					ALP.ClickOnSavebtn();
		...
		Logger.info("//===================================== DRAG&DROP State/Province City ATTRIBUTE =====================================//");
		Thread.sleep(3500);
		try {
			LF.SmartLeadAttributes();
			Logger.info("Click on Smart Lead Attributes is passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Smart Lead Attributes is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
			LF.StateProvinceDND();
			Logger.info("Drag and Drop State/Province is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Drag and Drop State/Province is FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2000);
		try {
			...
			Thread.sleep(2000);
			ALP.SelectIninAccName();
			Logger.info("Select In in Account Name is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select In in Account Name is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(500);
		try {
			if( LR.DisplayedStateOrProvinceSelectBoxNgValid()==true) {
				Logger.info("Dispalyed Select Box is not red");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
		...
		Thread.sleep(2000);
		try {
			LF.AddbtnForStateProvince();
			Logger.info("Click on AddbtnForState/Province is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on AddbtnForState/Province is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2000);
		try {
			...
			rrp.TextAreaLongitudeAlphabet();
			Logger.error("Enter Text in TextAreaa Failed!!",e);
		}	
		Thread.sleep(1500);
		try {
			rrp.EnterFreeTestForIN();
		...
		Thread.sleep(600);
		try {
			if( LR.DisplayedStateOrProvinceInputBoxNgValid()==true) {
				Logger.info("Dispalyed Input Box is not red");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnCRMLeadFilterFeature();
			Logger.info("Click On CRMLeadFilter Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on CRMLeadFilter Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if( LF.DisplayALeadListOverView()==true) {
				Logger.info("Display CRMLeadFilter OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display CRMLeadFilter OverView Page is Failed", e);
			sa.assertAll();
		}
