...
@Test
public class SRandAccountMapping_LeadManagement extends BaseClass{
	...
	public void LeadManagement() throws InterruptedException {
		...
		String Text="";
		try {
			Text=SR.FetchedtheAccountNameTextFromConsole();
			Logger.info("Fetch the Account Name Text From Console is Passed");
			Logger.info("Account Name Is: "+Text);
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Fetch the Account Name Text From Console is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		driver.findElement(By.xpath("//input[@placeholder='Filter']")).sendKeys(Text);
		Thread.sleep(2500);
		boolean isDisplayed = driver.findElement(By.xpath("((//td[contains(@class,'mat-column-AccountName')])[1]//span[text()])[1]")).isDisplayed();
		if (isDisplayed==true) {
			Logger.info("Displayed Fetched Account name in console is Passed");
			Thread.sleep(2500);
			try {
				SR.ClearedFilterBox();
			...
			sa.assertTrue(false);
			Logger.error("Not Displayed Fetched Account name in console");
			sa.assertAll();
		}
		...
		Thread.sleep(2500);
		if (SR.DisplayedIgnoreThisAccountFromAffinityBasedAssignmentCheckBoxIsChecked()==true) {
			Thread.sleep(2500);
			try {
				SR.ClickedOnCheckBoxForIgnoreThisAccountFromAffinityBasedAssignment();
				Logger.info("Uncheck the CheckBox For Ignore This Account From Affinity Based Assignment is Passed");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Uncheck the CheckBox For Ignore This Account From Affinity Based Assignment is Failed", e);
				sa.assertAll();
			}
			Thread.sleep(2500);
			try {
				if (SR.DisplayedIgnoreThisAccountFromAffinityBasedAssignmentCheckBoxIsUnChecked()==true) {
					Logger.info("Displayed Ignore This Account From Affinity Based Assignment CheckBox Is UnChecked is Passed");
				}
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Displayed Ignore This Account From Affinity Based Assignment CheckBox Is UnChecked is Failed", e);
				sa.assertAll();
			}
			...
			try {
				SR.ClickedOnCheckBoxForIgnoreThisAccountFromAffinityBasedAssignment();
				Logger.info("Click On CheckBox For Ignore This Account From Affinity Based Assignment is Passed");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Click On CheckBox For Ignore This Account From Affinity Based Assignment is Failed", e);
				sa.assertAll();
			}
			Thread.sleep(2500);
			try {
				if (SR.DisplayedIgnoreThisAccountFromAffinityBasedAssignmentCheckBoxIsChecked()==true) {
					Logger.info("Displayed Ignore This Account From Affinity Based Assignment CheckBox Is Checked is Passed");
				}
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("Displayed Ignore This Account From Affinity Based Assignment CheckBox Is Checked is Failed", e);
				sa.assertAll();
			}
		}
		Thread.sleep(2500);
		...
		try {
			...
			sa.assertTrue(false);
			Logger.error("Click On DeleteIcon is Failed", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
