...
public class TC_Sanity_LeadRouter_LeadManagement extends BaseClass {
	private final static Logger Logger = org.apache.logging.log4j.LogManager
			.getLogger(TC_Sanity_LeadRouter_LeadManagement.class);	
	@Test(description = "LeadManagement_LeadRouter _Section")
	@Step("LeadManagement_LeadRouting_LeadRouter")
	@Description("LeadManagement_LeadRouting_LeadRouter")
	public void LeadManagementTest() throws InterruptedException {
		...
		try {
			...
			Logger.info("Click on leadRouting dropdown is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on leadRouting dropdown is Failed", e);
			sa.assertAll();
		}
		Thread.sleep(4900);
		try {
		...
		Thread.sleep(2500);
		try {
			LR.ClickOnLRContinueProcessingCheckBox();
		...
		Thread.sleep(2500);
		try {
			LR.ClickOnLRStopProcessingCheckBox();
					...
					if (getLinkTextSecondListBox.contains("Set to (Text/Number/Date)")==true) {
						...
						if (i==1) {
							try {
								...
								Logger.info("Enter Number for Lattitude is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Enter Number for Lattitude is Failed !!",e);
								sa.assertAll();
							}
							Thread.sleep(2500);
							try {
							...
							try {
								...
								Logger.info("Click On ConvertedDate Calendar Button is PASSED!!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Click On ConvertedDate Calendar Button is FAILED!!!", e);
								sa.assertAll();
							}
							Thread.sleep(1500);
							try {
						...
						for (int k = 0; k <3; k++) {
							Thread.sleep(3000);
							try {
								LR.SelectThirdListBoxdropdownForUpdateDataValue();
						...
						for (int M = 1; M <= 3; M++) {
							...
							try {
								...
								Logger.info("Click On Save Button for Incert Value Popup is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Click On Save Button for Incert Value Popup is Failed !!",e);
								sa.assertAll();
							}
							Thread.sleep(2500);
							try {
		...
		Thread.sleep(2500);
		try {
			LR.SelectEscalateLeadsCheckBox();
			Logger.info("Select EscalateLeads CheckBox is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select EscalateLeads CheckBox is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickOnDaysDropDown();
			Logger.info("Click On Days DropDown is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Days DropDown is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickAnOption();
			Logger.info("Click On Days option is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Days option is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickOnHoursDropDown();
			Logger.info("Click On Hours DropDown is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Hours DropDown is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickAnOption();
			Logger.info("Click On Hours option is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Hours option is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickOnMinutesDropDown();
			Logger.info("Click On Minutes DropDown is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Minutes DropDown is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.ClickAnOption();
			Logger.info("Click On Minutes option is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Minutes option is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LR.SelectExcludeOffHoursCheckBox();
			Logger.info("Select Exclude off hours, holidays and weekends from elapsed time calculation checkbox is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select Exclude off hours, holidays and weekends from elapsed time calculation checkbox is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if (LR.DisplayedExcludeOffHoursCheckBoxIsChecked()==true) {
				Logger.info("Displayed Exclude off hours, holidays and weekends from elapsed time calculation CheckBox Is Checked!!");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Displayed Exclude off hours, holidays and weekends from elapsed time calculation CheckBox Is Not Checked!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		for (int i = 1; i < CountAllLinks; i++) {//CountAllLinks
			...
			if (getLinkTextAssignmentFirstListBox.contains("Assign Based on a Lookup Field in the Parent Account")==true ||
				...
				if (getLinkTextAssignmentFirstListBox.contains("Assign to Parent Accounts Owner")==true) {
					...
					try {
						LPWR.SelectCreateTaskForTheNewSuggestedOwnerOption();
						Logger.info("Select CappingCondition Option is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select CappingCondition Option is Failed !!",e);
						sa.assertAll();
					}
					Thread.sleep(1500);
					try {
			...
			else if (getLinkTextAssignmentFirstListBox.contentEquals("Execute Sub Router")==true) {
				Thread.sleep(2000);
				try {
					LPWR.SelectDropDownForAssignToQueue();
					Logger.info("Click on main second Select DropDown is Passed");
				...
				//****************
				Thread.sleep(3000);
				String ObjectNameBeforeClickNewTabLink9 = driver.findElement(By.xpath("(//mat-icon[@fonticon='open_in_new'])[1]//..//..//span[text()]")).getText();
				Logger.info("Object Name Before Click NewTab Link: "+ObjectNameBeforeClickNewTabLink9);
				Thread.sleep(3000);
				try {
					LR.ClickOnOpenInNewTabLinkForAssignmentBlock();
					Logger.info("Click On Open In New Tab Link is Passed !!");
				...
				for (String wh : Allwindow9) {
					...
					if (wh.equals(ParentWindow)) {
						...
						Thread.sleep(4000);
						try {
							if (ObjectNameBeforeClickNewTabLink9.contentEquals(ObjectNameAfterClickNewTabLink)) {
								Logger.info("Open in New tab link is properly redirected is Passed !!");
							}
						} catch (Exception e) {
							sa.assertTrue(false);
		...
		Thread.sleep(2500);
		try {
			LR.LeadRouterFeederRadioButton2();
			Logger.info("Click On Route based on selected feeder Check box is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Route based on selected feeder Check box is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.ClickOnSuggestedNewOwnerDropDown();
			Logger.info("Click On Route based on selected feeder DropDown is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Route based on selected feeder DropDown is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.SelectSuggestedNewOwnerOption();
			Logger.info("Select Route based on selected feeder Option is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select Route based on selected feeder Option is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.CheckBoxForSuggestedNewOwner();
			Logger.info("Check Box For Route based on selected feeder is Passed!!");

		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Check Box For Route based on selected feeder is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(900);
		try {
			detrrt.DisplaySuccessForSuggestedNewOwner();
			Logger.info("Display Success For Route based on selected feeder is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display Success For Route based on selected feeder is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
			...
			sa.assertTrue(false);
			Logger.error("Default LeadOwner DropDown is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		try {
			...
			Logger.info("CheckBox For DefaultLeadOwner is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("CheckBox For DefaultLeadOwner is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(900);
		try {
		...
		try {
			...
			Logger.info("DataValueUpdateWhenRoutedToDefaultLeadOwner AddButton is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("DataValueUpdateWhenRoutedToDefaultLeadOwner AddButton is Failed!!", e);
			sa.assertAll();
		}
		...
		for (int D = 0; D < 4; D++) {//D
			...
			if (D==0) {//j0
				...
				try {
					rrp.CreatedDateCalendarButtonBox1();
					Logger.info("Click On ConvertedDate Calendar Button Box1 is PASSED!!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Click On ConvertedDate Calendar Button Box1 FAILED!!!", e);
					sa.assertAll();
				}
				Thread.sleep(1500);
				try {
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnLeadRouterFeature();
			Logger.info("Click On Lead Router Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Lead Router Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if(LR.isDisplayLeadRouterOverview()==true) {
				Logger.info("Display LeadRouter OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display LeadRouter OverView Page is Failed", e);
			sa.assertAll();
		}
		...
		if (LR.DisplayedColumnHeaderCheckIsDisabled()==false) {
			...
			if (LR.DisplayedAutTestObjectCheckBox()==true) {
				...
				try {
					if (LR.DisplayedAutoTestObjectIsNotUsed() == true) {
						Logger.info("Displayed AutoTestObject is not Uesed is Passed");
					}
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Displayed AutoTestObject is not Used is Failled", e);
