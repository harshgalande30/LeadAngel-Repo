...
public class TC_CrudOperation_WaitFilter extends BaseClass {
	private final static Logger Logger = org.apache.logging.log4j.LogManager
			.getLogger(TC_CrudOperation_WaitFilter.class);
	...
	public void LeadManagementTest() throws InterruptedException {
		...
		try {
			...
			sa.assertTrue(false);
			Logger.error("Click on First Name DoesNotContains FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
