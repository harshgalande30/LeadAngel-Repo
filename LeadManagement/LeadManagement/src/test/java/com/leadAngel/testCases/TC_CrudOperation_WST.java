...
public class TC_CrudOperation_WST extends BaseClass {
	private final static Logger Logger = org.apache.logging.log4j.LogManager.getLogger(TC_CrudOperation_WST.class);
	@Test(description = "LeadManagement_WeightedSalesTeam _Section")
	@Step("LeadManagement_WeightedSalesTeam")
	@Description("LeadManagement_WeightedSalesTeam")
	public void LeadManagementTest() throws InterruptedException, IOException {
		...
		Logger.info("Click on New Weighted Sales Team is Passed ");
		...
		if(ae.DisplaySameAEerror() == true) {
			...
			try {
				...
				sa.assertTrue(false);
				Logger.error("Click on New Weighted Sales Team is FAILED!!", e);
				sa.assertAll();
			}
			Thread.sleep(4900);
			try {
		...
		try {
			wst.SalesRepWST_DND();              	
			Logger.info("Drag And Drop SalesRep1 is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Drag And Drop SalesRep1 is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try { 
			wst.ClickInputSalesRep();
			Logger.info("Click Inputbox1 on SalesRep is PASSED!!");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click Inputbox1 on SalesRep is FAILED!! ");
			sa.assertAll();
		}
		...
		try {
			...
			Logger.info("Select option SalesRep is PASSED!!");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Select option SalesRep is FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		try {
			...
			sa.assertTrue(false);
			Logger.error("Input on Details TextArea is Failed",e);
			sa.assertAll();
		}
		Thread.sleep(3000);
		try {
		...
		Logger.info("Click On Queue Owner is Passed");
		Thread.sleep(2500);
		detrrt.SelectQueueOwner();              
		Logger.info("Select Queue Owner Option is Passed");
//		Thread.sleep(2500);
//		try {
//			detrrt.ClickOnQueOwnerInDetailsPageCheckBox2();
//			Logger.info("Click On QueOwner In DetailsPage CheckBox2 is Passed");
//		} catch (Exception e) {
//			sa.assertTrue(false);
//			Logger.error("Click On QueOwner In DetailsPage CheckBox2 is FAILED", e);
//			sa.assertAll();
//		}
		Thread.sleep(2500);
		try {
		...
		try {
			...
			Logger.info("Dislay SuccessMessage is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Dislay SuccessMessage is FAILED", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		Logger.info("======================================= Go back To WST Object ==================================");
		Thread.sleep(3000);
		try {
			LMP.ClickonSalesTeam();
			Logger.info("Click on Sales Team is Passed");
		...
		try {
			LR.WeightEdit();
			Logger.info("Input On Weight is Passed");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Input On Weight is FAILED!", e);
			sa.assertAll();
		}
