...
public class TC_CrudOperation_TaskList extends BaseClass {
	private final static Logger Logger = org.apache.logging.log4j.LogManager
			.getLogger(TC_CrudOperation_TaskList.class);
	...
	public void LeadManagementTest() throws InterruptedException {
		...
		Logger.info("Click on New TaskList is Passed");
		Thread.sleep(2500);
		try {
		...
		if(ae.DisplaySameAEerror() == true) {
			...
			try {
				...
				Logger.info("TaskList DropDown is passed");
			}catch(Exception e) {
				sa.assertTrue(false);
				Logger.error("TaskList DropDown is FAILED!!", e);
				sa.assertAll();
			}
			Thread.sleep(3500);
			try {
			...
			try {
				...
				sa.assertTrue(false);
				Logger.error("Click on New TaskList is FAILED!!", e);
				sa.assertAll();
			}
			Thread.sleep(3000);
			try {
		...
		Thread.sleep(2500);
		try {
			LMP.ClickOnPriorityNormal();
			Logger.info("Click on Priority Normal is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Priority Normal is FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.ClickOnStatusInProgress();
			Logger.info("Click on Status InProgress is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Status InProgress is FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
		...
		Logger.info("//*********************************************** Make Use of this Object in leadRouter *******************************************");
		Thread.sleep(4500);
		try {
		...
		try {
			LMP.ClickOnRadioBtn();
			Logger.info("Click on Radio Button is PASSED!!");	
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Radio Button is FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.InputOnRadioBtn();
			Logger.info("Input on Due with In days in PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Input on Due with In days in FAILED!!",e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.ClickOnPriorityLow();
			Logger.info("Click on Priority Low is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Priority Low is FAILED!!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			LMP.ClickOnStatusCompleted();
			Logger.info("Click on Status Completed is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Status Completed is FAILED!!!", e);
			sa.assertAll();
		}
