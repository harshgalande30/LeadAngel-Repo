...
//----------------- DATA DICTIONARY----------------//	
	...
	@FindBy(xpath="//button[@aria-label='toggle Inactive Lead Owner Management']")
	WebElement InActiveLeadOwnerManagement;
...
//----------------FOR CRUD OPERATION FOLDER'S---------------------//	
	...
	@FindBy(xpath="//button[@aria-label='toggle 16.11fldr1']")
	WebElement ClickCappingFolder;
	@FindBy(xpath="//button[@aria-label='toggle .....Folder']")
	WebElement ClickContactFolder;
	@FindBy(xpath="//button[@aria-label='toggle f456']")
	WebElement ClickCRMLeadFilterFolder;
	@FindBy(xpath="//button[@aria-label='toggle ..Folder12']")
	WebElement ClickLeadRouterFolder;
	@FindBy(xpath="//button[@aria-label='toggle ..15fldr']")
	WebElement ClickLeadRoutingTeritoryFolder;
	...
	@FindBy(xpath="//button[@aria-label='toggle 16.11fldr']")
	WebElement EscalConditionFolder;

	@FindBy(xpath="//button[@aria-label='toggle asdfg']")
	...
	@FindBy(xpath="//button[@aria-label='toggle f11']")
	WebElement WFFolder;
...
//-----------------  WAIT FILTER ------------------------------//
	...
	@FindBy(xpath="(//label[text()='Wait till']/..//select[@name='seldropDown'])[1]")
	WebElement ClickOnWaitFilterOptionInWaitCondition;
...
//-------------------CRM Opportunity Filter--------------------//
   ...
   WebElement LeadRoutingTerritory;
	...
	WebElement CheckBoxForAssignmentBlockAutoConvertEscalationRouter;
	...
	@FindBy(xpath="//ng-select[@placeholder='Select Wait Condition']")
	WebElement SelectListBoxWaitDropDownActionBlock;
	...
	@FindBy(xpath = "//span[text()=' Create Task for the New Owner ']//..//..//..//..//mat-select[@role='combobox']")
	WebElement ClickCreateTaskfortheNewOwnerDropDown;
	@FindBy(xpath = "//span[text()=' Capping Condition ']//..//span[@class='mat-checkbox-inner-container']")
	WebElement ClickCappingConditionCheckBox;
	@FindBy(xpath = "//span[text()='Select Capping/Leveling Condition']")
	WebElement ClickCappingConditionDropDown;
	@FindBy(xpath = "//input[@formcontrolname='CappingLimitNumber']")
	WebElement InputforCappingConditionBox;
	...
	public void ClickCappingConditionCheckBox() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickCappingConditionCheckBox));
		ClickCappingConditionCheckBox.click();
	}
	public void ClickCappingConditionDropDown() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickCappingConditionDropDown));
		ClickCappingConditionDropDown.click();
	}
	public void InputforCappingConditionBox() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(InputforCappingConditionBox));
		InputforCappingConditionBox.clear();
		InputforCappingConditionBox.sendKeys("315");
	}
		
	
	public void ClickCreateTaskfortheNewOwnerDropDown() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickCreateTaskfortheNewOwnerDropDown));
		ClickCreateTaskfortheNewOwnerDropDown.click();
	}
	...
	public void SelectListBoxActionDropDownBlock() {
	...
	public void SelectListBoxWaitDropDownActionBlock() {
		new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectListBoxWaitDropDownActionBlock));
		SelectListBoxWaitDropDownActionBlock.click();
	}
	
	//***************************************SubRouter Router************************************************

	@FindBy(xpath = "//span[text()='Sub Router ']")
	WebElement RightClickSubRouter;
	@FindBy(xpath = "//span[text()='Sub Router ']")
	WebElement ClickAganiSubRouter;
	@FindBy(xpath = "//button[@aria-label='toggle Sub Router']")
	WebElement DropDownSubRouter;
	
	@FindBy(xpath = "//h4[text()='Sub Router Overview']")
	WebElement DisplaySubRouterOverview;
	
	@FindBy(xpath="//button[@aria-label='toggle Automation']")
	WebElement ClickSubRouterFolder;
	
	@FindBy(xpath="//div[contains(text(),'Lead Filter')]")
	WebElement LeadFilterForSubRouter;
	
	@FindBy(xpath="(//div[contains(text(),'Assignment')])[1]")
	WebElement AssignmentBlockForSubRouter;
	...
	public void RightClickOnClickEscalationRouter() {
		...
		actions.moveToElement(EscalationRouterDropDown).contextClick(EscalationRouterDropDown).build()
				.perform();
	}
	...
	public void CheckBoxForAssignmentBlockAutoConvertEscalationRouter()
	{
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(CheckBoxForAssignmentBlockAutoConvertEscalationRouter));
		CheckBoxForAssignmentBlockAutoConvertEscalationRouter.click();
	}
...
public void ClickOnNewFolder() {
	...
	public void RightClickonEscalationCondition() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(EscalationCondition).contextClick(EscalationCondition).build()
				.perform();
	}
...
public void ClickonConverted_Is() {
	...
	public void RightClickonWST() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(WeightedSalesTeam).contextClick(WeightedSalesTeam).build()
				.perform();
	...
	public void RightClickOnAccList() {
		...
		actions.moveToElement(AccList).contextClick(AccList).build().perform();
	}
	...
	public void RightClickonCRM_AccFilter() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(CRM_Acc_Filter).contextClick(CRM_Acc_Filter).build().perform();
	}
	...
	public void RightClickonCRM_LeadFilter() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(NewCRM_Lead_Filter).contextClick(NewCRM_Lead_Filter).build()
		.perform();
...
//		js.executeScript("arguments[0].click()", renameBtn);
	...
	public void InActiveLeadOwnerManagement() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(InActiveLeadOwnerManagement));
		InActiveLeadOwnerManagement.click();
	}
	...
	public void RightClickonInActiveOwnertoSalesRep() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(InActiveOwnertoSalesRep).contextClick(InActiveOwnertoSalesRep).build().perform();
	...
	public void RightClickOnCappingLeveling() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(CappingLeveling)
...
//----------------------------WAIT FILTER-----------------------------//
	...
	public void RightClickonWaitFilter() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(ClickAgainWaitFilter).contextClick(ClickAgainWaitFilter).build()
				.perform();
...
//---------------------------WAIT CONDITION----------------------//
	...
	public void RightClickonWaitCondition() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(WaitCondition).contextClick(WaitCondition).build()
				.perform();
	...
	public void WaitFil_DND() {
	 ...
	 public void ClickOnWaitFilterOptionInWaitCondition() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickOnWaitFilterOptionInWaitCondition));
			ClickOnWaitFilterOptionInWaitCondition.click();
	}
	
		//-------------------------TaskList------------------------------//
	    @FindBy(xpath="(//label[@class='mat-radio-label'])[2]")
		WebElement ClickOnDueWithinDaysRadioButton;
	    @FindBy(xpath="//input[@name='TaskDueDays']")
		WebElement EnterDueWithinDays;
		@FindBy(xpath="//select[@name='TaskPriority']")
		...
		WebElement ClickStatusDropDown;
		  ...
		  public void ClickStatusDropDown() {
				new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickStatusDropDown));
				ClickStatusDropDown.click();
			}
		  public void ClickPriorityDropDown() {
				new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickPriorityDropDown));
				ClickPriorityDropDown.click();
			}
	    public void ClickOnDueWithinDaysRadioButton() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickOnDueWithinDaysRadioButton));
			ClickOnDueWithinDaysRadioButton.click();
		}
		public void EnterDueWithinDays() {
			new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(EnterDueWithinDays));
			EnterDueWithinDays.clear();
			EnterDueWithinDays.sendKeys("33");
		}
		...
		public void RightClickonTaskList() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(TaskList).contextClick(TaskList).build()
					.perform();
		}
	...
	//----------------------  Opportunity Filter--------------------//
			...
			public void ClickOnIdContains() {
			 ...
			 public void ClickOnIdInAddbtn() {
				...
				public void ClickCRMLeadFilterFolder() {
					new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickCRMLeadFilterFolder));
					ClickCRMLeadFilterFolder.click();
				}
				
				public void ClickLeadRouterFolder() {
					new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickLeadRouterFolder));
					ClickLeadRouterFolder.click();
				}
				public void ClickLeadRoutingTeritoryFolder() {
					new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickLeadRoutingTeritoryFolder));
					ClickLeadRoutingTeritoryFolder.click();
				}
...
//-----------------------------CRUD OPERATION----------------------------//		
	...
	public void DescInRRT() {
		...
		txtDesc.sendKeys("New Automation Testing Going on...!!!");
	}
	...
	public void ContextClickOnAutoTestObject() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(AutoTestObject).contextClick(AutoTestObject).build().perform();
	}
...
public void FullName_DND() {
		...
		public void ClickOnFullNameStartWith() {
		 ...
		 public void ClickOnFullNameInAddbtn() {
			...
			public void ClickOnAutoTestObject() {
				...
				//Actions actions = new Actions(ldriver);
				//actions.moveToElement(AutoTestObject).click(AutoTestObject);
				AutoTestObject.click();
 ...
 //*****************************************************Lead Routing Page DropDown********************************************
		 ...
		 //*****************************************************SubRouter Page DropDown********************************************
	 
		 public void RightClickSubRouter() {
			 new WebDriverWait(ldriver, Duration.ofSeconds(25))
			 .until(ExpectedConditions.elementToBeClickable(RightClickSubRouter));
			 Actions actions = new Actions(ldriver);
			 actions.moveToElement(RightClickSubRouter).contextClick(RightClickSubRouter).build()
			 .perform();
		 }
		 
			public void DropDownSubRouter()
			{
				new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(DropDownSubRouter));
				DropDownSubRouter.click();
			}
			public boolean DisplaySubRouterOverview() {
				  new WebDriverWait(ldriver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOf(DisplaySubRouterOverview));
				  return DisplaySubRouterOverview.isDisplayed();
			}
			public void ClickSubRouterFolder() {
				new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickSubRouterFolder));
				ClickSubRouterFolder.click();
			}

			public void ClickAganiSubRouter()
			{
				new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(ClickAganiSubRouter));
				ClickAganiSubRouter.click();
			}
			public void LeadFilterForSubRouter_DND() {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(LeadFilterForSubRouter));
				Actions actions = new Actions(ldriver);
				actions.moveToElement(LeadFilterForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .clickAndHold(LeadFilterForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .moveByOffset(-425,95) //change the x, y values to be applicable for your cases
		        .moveByOffset(-425,95)
		        .pause(Duration.ofSeconds(1))
		        .release().build().perform();
			}
			
			public void AssignmentBlock1ForSubRouter_DND() {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(AssignmentBlockForSubRouter));
				Actions actions = new Actions(ldriver);
				actions.moveToElement(AssignmentBlockForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .clickAndHold(AssignmentBlockForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .moveByOffset(-300,125) //change the x, y values to be applicable for your cases
		        .moveByOffset(-300,125)
		        .pause(Duration.ofSeconds(1))
		        .release().build().perform();
			}
			public void LeadFilter2ForSubRouter_DND() {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(LeadFilterForSubRouter));
				Actions actions = new Actions(ldriver);
				actions.moveToElement(LeadFilterForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .clickAndHold(LeadFilterForSubRouter)
		        .pause(Duration.ofSeconds(1))
		        .moveByOffset(-330,20) //change the x, y values to be applicable for your cases
		        .moveByOffset(-330,20)
		        .pause(Duration.ofSeconds(1))
		        .release().build().perform();
			}
			public void AssignmentBlock2ForSubRouter_DND() {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(AssignmentBlockForSubRouter));
				Actions actions = new Actions(ldriver);
				actions.moveToElement(AssignmentBlockForSubRouter)
		        .pause(Duration.ofSeconds(1))
			...
			public void AssignmentBlock3ForSubRouter_DND() {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(AssignmentBlockForSubRouter));
				Actions actions = new Actions(ldriver);
				actions.moveToElement(AssignmentBlockForSubRouter)
		        .pause(Duration.ofSeconds(1))
