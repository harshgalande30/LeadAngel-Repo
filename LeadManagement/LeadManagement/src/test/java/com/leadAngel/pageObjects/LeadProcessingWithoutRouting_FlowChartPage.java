...
public class LeadProcessingWithoutRouting_FlowChartPage {
	...
	@FindBy(xpath = "//span[text()='If no one is available, hold the lead till someone is available ']//..//span[@class='mat-checkbox-inner-container']")
...
//	}
	public void ClickPreferHistoricalSalesPersonToAccountAffinityWhileAssigningCheckBox() {
		...
		js.executeScript("arguments[0].click()", ClickPreferHistoricalSalesPersonToAccountAffinityWhileAssigningCheckBox);
	}
