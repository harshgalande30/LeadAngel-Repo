...
public class LeadRouterPageObjectModel {
	...
	//*****************************************************Lead Router Flow Chart*****************************************
		...
		@FindBy(xpath="//ng-select[@formcontrolname='webhookvalue']")
		WebElement SelectSecondListBoxActionBlock;
		...
		WebElement CheckBoxForAssignmentBlockAEtoSDRAccountRouter;
		...
		@FindBy(xpath = "//ng-select[@formcontrolname='webhookvalue']")
		WebElement ClickOnSecondSelectBoxDropdownActionBlockOTSCR;
		
		
		public void ClickOnSecondSelectBoxDropdownActionBlockOTSCR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnSecondSelectBoxDropdownActionBlockOTSCR));
			ClickOnSecondSelectBoxDropdownActionBlockOTSCR.click();
		}
...
//		}
		...
		public void SelectSecondListBoxActionBlock() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectSecondListBoxActionBlock));
			SelectSecondListBoxActionBlock.click();
		}
...
//		}
		...
		public void CheckBoxForAssignmentBlockAEtoSDRAccountRouter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(CheckBoxForAssignmentBlockAEtoSDRAccountRouter));
			CheckBoxForAssignmentBlockAEtoSDRAccountRouter.click();
		}
...
//		}
		...
		WebElement SelectThirdListBoxdropdownForUpdateDataValueAR;
		...
		public void SelectThirdListBoxdropdownForUpdateDataValueAR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectThirdListBoxdropdownForUpdateDataValueAR));
			SelectThirdListBoxdropdownForUpdateDataValueAR.click();
		}
	...
	//******************************************************* Restart to Edit *********************************************	
		...
		@FindBy(xpath = "(//span[text()=' Create Task for the New Suggested owner ']//..)[1]")
		WebElement ClickOnCreateTaskForTheNewSuggestedOwnerCheckBox;
		...
		WebElement ClickOnAccountRouterFeature;
		@FindBy(xpath="//span[text()='Contact Router ']")
		WebElement ClickOnContactRouterFeature;
		...
		WebElement DisplayedAccountRouterFeederCheckBox;
		...
		public boolean DisplayedAccountRouterFeederCheckBox() {
			try {
				new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOf(DisplayedAccountRouterFeederCheckBox));
				return DisplayedAccountRouterFeederCheckBox.isDisplayed();
			} catch (Exception e) {
			return false;
			}
		}
		...
		public void ClickOnContactRouterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnContactRouterFeature));
			ClickOnContactRouterFeature.click();
		}
		public void ClickOnAccountRouterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnAccountRouterFeature));
			ClickOnAccountRouterFeature.click();
		}
		...
		public void ClickOnCreateTaskForTheNewSuggestedOwnerCheckBox() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnCreateTaskForTheNewSuggestedOwnerCheckBox));
			ClickOnCreateTaskForTheNewSuggestedOwnerCheckBox.click();
		}
	...
	//*****************	
		...
		@FindBy(xpath="//span[text()='AutoTestObject']//..//i[contains(@class,'crm-contact-filter')]")
		WebElement SelectAutoTestObjectCRMContactFilter;
		...
		public void SelectAutoTestObjectCRMContactFilter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(SelectAutoTestObjectCRMContactFilter));
			SelectAutoTestObjectCRMContactFilter.click();
		}
		...
		@FindBy(xpath = "//label[text()='CRM Contact Filter']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedCRMContactFilterSelectBoxNgValid;
		@FindBy(xpath = "//label[text()='CRM Contact Filter']//..//ng-select[contains(@class,'ng-valid')]")
		 WebElement DisplayedCRMContactFilterNgSelectBoxBoxNgValid;
		
		
		public boolean DisplayedCRMContactFilterSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedCRMContactFilterSelectBoxNgValid));
			return DisplayedCRMContactFilterSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedCRMContactFilterNgSelectBoxBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedCRMContactFilterNgSelectBoxBoxNgValid));
			return DisplayedCRMContactFilterNgSelectBoxBoxNgValid.isDisplayed();
		}
		...
		WebElement ClickOnContactRoutingTerritoryFeature;
		
		@FindBy(xpath="//span[text()='CRM Contact Filter ']")
		WebElement ClickOnCRMContactFilterFeature;
		...
		public void ClickOnCRMContactFilterFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnCRMContactFilterFeature));
			ClickOnCRMContactFilterFeature.click();
		}
		
		
		public void ClickOnContactRoutingTerritoryFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnContactRoutingTerritoryFeature));
			ClickOnContactRoutingTerritoryFeature.click();
		}
	...
	//***************************** Account Management Module ************************************
		...
		WebElement ClickOnAccountRoutingTerritoryFeature;
		
		@FindBy(xpath="(//span[@class='mat-radio-outer-circle'])[1]")
		WebElement ClickOnContinueProcessingCheckBoxAR;
		@FindBy(xpath="(//span[@class='mat-radio-outer-circle'])[2]")
		WebElement ClickOnStopProcessingCheckBoxAR;
		
		
		public void ClickOnStopProcessingCheckBoxAR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnStopProcessingCheckBoxAR));
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ClickOnStopProcessingCheckBoxAR);
		}
		public void ClickOnContinueProcessingCheckBoxAR() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnContinueProcessingCheckBoxAR));
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ClickOnContinueProcessingCheckBoxAR);
		}
		public void ClickOnAccountRoutingTerritoryFeature() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnAccountRoutingTerritoryFeature));
			ClickOnAccountRoutingTerritoryFeature.click();
		}
	
		//**************Wait Filter feature

		@FindBy(xpath = "//label[text()='Account Name']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedAccountNameSelectBoxNgValid;
		@FindBy(xpath = "//label[text()='Account Name']//..//input[contains(@class,'ng-valid')]")
		 WebElement DisplayedAccountNameInputBoxNgValid;
		
		
		@FindBy(xpath = "//label[text()='Billing Longitude ']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedBillingLongitudeSelectBoxNgValid;
		@FindBy(xpath = "(//label[text()='Billing Longitude ']//..//input[contains(@class,'ng-valid')])[1]")
		 WebElement DisplayedBillingLongitudeInputBoxNgValid1;
		@FindBy(xpath = "(//label[text()='Billing Longitude ']//..//input[contains(@class,'ng-valid')])[2]")
		 WebElement DisplayedBillingLongitudeInputBoxNgValid2;
		
		@FindBy(xpath = "(//label[text()='Deleted']//..//select[contains(@class,'ng-valid')])[1]")
		 WebElement DisplayedDeletedSelectBoxNgValid1;
		@FindBy(xpath = "(//label[text()='Deleted']//..//select[contains(@class,'ng-valid')])[2]")
		 WebElement DisplayedDeletedSelectBoxNgValid2;
		
		@FindBy(xpath = "//label[text()='Other Longitude ']//..//select[contains(@class,'ng-valid')]")
		 WebElement DisplayedOtherLongitudeSelectBoxNgValid;
		@FindBy(xpath = "(//label[text()='Other Longitude ']//..//input[contains(@class,'ng-valid')])[1]")
		 WebElement DisplayedOtherLongitudeInputBoxNgValid1;
		@FindBy(xpath = "(//label[text()='Other Longitude ']//..//input[contains(@class,'ng-valid')])[2]")
		 WebElement DisplayedOtherLongitudeInputBoxNgValid2;
		...
		public boolean DisplayedOtherLongitudeSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedOtherLongitudeSelectBoxNgValid));
			return DisplayedOtherLongitudeSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedOtherLongitudeInputBoxNgValid1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedOtherLongitudeInputBoxNgValid1));
			return DisplayedOtherLongitudeInputBoxNgValid1.isDisplayed();
		}
		public boolean DisplayedOtherLongitudeInputBoxNgValid2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedOtherLongitudeInputBoxNgValid2));
			return DisplayedOtherLongitudeInputBoxNgValid2.isDisplayed();
		}
		
		public boolean DisplayedDeletedSelectBoxNgValid1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedDeletedSelectBoxNgValid1));
			return DisplayedDeletedSelectBoxNgValid1.isDisplayed();
		}
		...
		public boolean DisplayedBillingLongitudeSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedBillingLongitudeSelectBoxNgValid));
			return DisplayedBillingLongitudeSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedBillingLongitudeInputBoxNgValid1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedBillingLongitudeInputBoxNgValid1));
			return DisplayedBillingLongitudeInputBoxNgValid1.isDisplayed();
		}
		public boolean DisplayedBillingLongitudeInputBoxNgValid2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedBillingLongitudeInputBoxNgValid2));
			return DisplayedBillingLongitudeInputBoxNgValid2.isDisplayed();
		}
		
		public boolean DisplayedAccountNameSelectBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedAccountNameSelectBoxNgValid));
			return DisplayedAccountNameSelectBoxNgValid.isDisplayed();
		}
		public boolean DisplayedAccountNameInputBoxNgValid() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(DisplayedAccountNameInputBoxNgValid));
			return DisplayedAccountNameInputBoxNgValid.isDisplayed();
		}
