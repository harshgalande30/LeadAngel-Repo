...
public class RoundRobinPage {
	...
	WebElement ClickOnApproveforContactRouter;
	...
	public void ClickOnApproveforContactRouter() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickOnApproveforContactRouter));
		ClickOnApproveforContactRouter.click();
	}
...
//	}
	...
	public void RightClickonAutoTestObject() {
		...
		//****************************************** Round Robit Team **********************************************	
		@FindBy(xpath = "(//label[text()='Created Date']/..//select[@name='seldropDown'])[1]")
		WebElement ClickDropDownCreateDateFirstBox;
		@FindBy(xpath = "(//label[text()='Created Date']/..//select[@name='seldropDown'])[2]")
		WebElement ClickDropDownCreateDate2forInPast;
		@FindBy(xpath = "//label[text()='About Me']/..//select[@name='seldropDown']")
		WebElement ClickDropDownAboutMe;
		

		@FindBy(xpath = "//label[text()='Other Latitude ']/..//select[@name='seldropDown']")
		WebElement ClickDropDownLongitude;
		
		@FindBy(xpath = "(//label[text()='Active']/..//select[@name='seldropDown'])[1]")
		WebElement ClickDropDownActivebox1;
		@FindBy(xpath = "(//label[text()='Active']/..//select[@name='seldropDown'])[2]")
		WebElement ClickDropDownActivebox2;
		@FindBy(xpath = "//textarea[@class='form-control ng-untouched ng-pristine ng-valid']")
		WebElement EnterFreeTestForIN;
		
		@FindBy(xpath = "//label[text()='Other Latitude ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement LongitudeInputBoxForIsGreaterThan;
		
		@FindBy(xpath = "(//label[text()='Other Latitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement LongitudeInputBoxForBetweenBox1;
		
		@FindBy(xpath = "(//label[text()='Other Latitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		WebElement LongitudeInputBoxForBetweenBox2;
		
		@FindBy(xpath = "//label[text()='Created Date']//..//input[@type='text']")
		WebElement CreatedDateInputBoxForInPastBox2;
		
		@FindBy(xpath = "(//button[@aria-label='Open calendar'])[1]")
		WebElement CreatedDateCalendarButtonBox1;
		
		@FindBy(xpath = "(//button[@aria-label='Open calendar'])[2]")
		WebElement CreatedDateCalendarButtonBox2;
		
		@FindBy(xpath = "//button[@mattooltip='Click to Select Filter']//span[text()='Default Filter ']")
		WebElement ClickDefaultFilterButton;
		
		@FindBy(xpath = "(//button[@role='menuitem'])[2]")
		WebElement SelectCustomFilterOption;
		
		@FindBy(xpath = "//input[@name='canvassearch']")
		WebElement InputForCutomFilter;
		
		@FindBy(xpath = "//input[@name='canvassearch']")
		WebElement InputForWaitCondition;
		
		@FindBy(xpath = "//mat-icon[text()=' unfold_more']")
		WebElement CollapseAll;
		
		@FindBy(xpath = "//mat-icon[text()=' unfold_less']")
		WebElement ExpandAll;

		@FindBy(xpath="//label[text()='Longitude ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForLongitude;
		@FindBy(xpath = "//label[text()='Other Longitude ']/..//select[@name='seldropDown']")
		WebElement ClickDropDownOtherLongitude;
		@FindBy(xpath="//label[text()='Other Longitude ']//..//mat-icon[text()='add_box']")
		WebElement AddbtnForOtherLongitude;
		@FindBy(xpath = "//label[text()='Other Longitude ']//..//input[@mattooltipclass='custom-tooltip-style']")
		WebElement OtherLongitudeInputBoxForIsGreaterThan;
		
		@FindBy(xpath = "(//label[text()='Other Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[1]")
		WebElement OtherLongitudeInputBoxForBetweenBox1;
		
		@FindBy(xpath = "(//label[text()='Other Longitude ']//..//input[@mattooltipclass='custom-tooltip-style'])[2]")
		WebElement OtherLongitudeInputBoxForBetweenBox2;
		
		@FindBy(xpath = "//li[text()=' Approved ']")
		WebElement isDisplayApproved;
		
		@FindBy(xpath = "(//button[@type='submit'])[2]")
		WebElement ApproveSubmitbtnForContactRouter;
		...
		public boolean isDisplayApproved() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(isDisplayApproved));
			return isDisplayApproved.isDisplayed();
		}
		
		public void ApproveSubmitbtnForContactRouter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ApproveSubmitbtnForContactRouter));
			//ApproveSubmitbtn.click();
			JavascriptExecutor js = (JavascriptExecutor) ldriver;
			js.executeScript("arguments[0].click()", ApproveSubmitbtnForContactRouter);
		}
		
		public void ClickDropDownCreateDateFirstBox() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownCreateDateFirstBox));
			ClickDropDownCreateDateFirstBox.click();
		}
		
		public void ClickDropDownCreateDate2forInPast() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownCreateDate2forInPast));
			ClickDropDownCreateDate2forInPast.click();
		}
		public void AddbtnForLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForLongitude));
			AddbtnForLongitude.click();
		}
		
		public void ClickDropDownAboutMe() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownAboutMe));
			ClickDropDownAboutMe.click();
		}
		
		public void ClickDropDownLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownLongitude));
			ClickDropDownLongitude.click();
		}
		
		public void ClickDropDownActivebox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownActivebox1));
			ClickDropDownActivebox1.click();
		}
		
		public void ClickDropDownActivebox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownActivebox2));
			ClickDropDownActivebox2.click();
		}
		
		public void EnterFreeTestForIN() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(EnterFreeTestForIN));
			EnterFreeTestForIN.sendKeys("58652");
		}

		public void LongitudeInputBoxForIsGreaterThan() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(LongitudeInputBoxForIsGreaterThan));
			LongitudeInputBoxForIsGreaterThan.sendKeys("46545218");
		}

		public void LongitudeInputBoxForBetweenBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(LongitudeInputBoxForBetweenBox1));
			LongitudeInputBoxForBetweenBox1.sendKeys("64785");
		}

		public void LongitudeInputBoxForBetweenBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(LongitudeInputBoxForBetweenBox2));
			LongitudeInputBoxForBetweenBox2.sendKeys("89455");
		}

		public void CreatedDateInputBoxForInPastBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(CreatedDateInputBoxForInPastBox2));
			CreatedDateInputBoxForInPastBox2.sendKeys("58");
		}

		public void CreatedDateCalendarButtonBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(CreatedDateCalendarButtonBox1));
			CreatedDateCalendarButtonBox1.click();
		}

		public void CreatedDateCalendarButtonBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(CreatedDateCalendarButtonBox2));
			CreatedDateCalendarButtonBox2.click();
		}

		public void ClickDefaultFilterButton() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDefaultFilterButton));
			ClickDefaultFilterButton.click();
		}
		
		public void SelectCustomFilterOption() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(SelectCustomFilterOption));
			SelectCustomFilterOption.click();
		}
		
		public void InputForCutomFilter() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(InputForCutomFilter));
			InputForCutomFilter.sendKeys("1 and 2 and 3 and 4");
		}
		public void InputForWaitCondition() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(InputForWaitCondition));
			InputForWaitCondition.sendKeys("1 and 2 and 3");
		}
		...
		public void ExpandAll() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ExpandAll));
			ExpandAll.click();
		}
		
		
		
		public void ClickDropDownOtherLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(ClickDropDownOtherLongitude));
			ClickDropDownOtherLongitude.click();
		}
		
		public void AddbtnForOtherLongitude() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(AddbtnForOtherLongitude));
			AddbtnForOtherLongitude.click();
		}
		
		public void OtherLongitudeInputBoxForIsGreaterThan() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(OtherLongitudeInputBoxForIsGreaterThan));
			OtherLongitudeInputBoxForIsGreaterThan.sendKeys("46545218");
		}

		public void OtherLongitudeInputBoxForBetweenBox1() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(OtherLongitudeInputBoxForBetweenBox1));
			OtherLongitudeInputBoxForBetweenBox1.sendKeys("64785");
		}

		public void OtherLongitudeInputBoxForBetweenBox2() {
			new WebDriverWait(ldriver, Duration.ofSeconds(30))
			.until(ExpectedConditions.elementToBeClickable(OtherLongitudeInputBoxForBetweenBox2));
			OtherLongitudeInputBoxForBetweenBox2.sendKeys("89455");
		}
