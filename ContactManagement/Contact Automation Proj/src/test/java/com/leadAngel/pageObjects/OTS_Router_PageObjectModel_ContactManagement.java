...
public class OTS_Router_PageObjectModel_ContactManagement {

	
	WebDriver ldriver;

	public OTS_Router_PageObjectModel_ContactManagement(WebDriver rdriver) {
		ldriver = rdriver;
	...
	@FindBy(xpath = "(//div[text()='Select Email Template']//..//..//span[@class='ng-arrow-wrapper'])[1]")
	...
	@FindBy(xpath = "(//div[text()='Select Slack Template']//..//..//span[@class='ng-arrow-wrapper'])[1]")
	...
	@FindBy(xpath = "(//div[text()='Select Text Template']//..//..//span[@class='ng-arrow-wrapper'])[1]")
	...
	WebElement ClickSelectEmailTemplateDropDownAssignmentSetupCR;
	...
	WebElement ClickSelectSlackTemplateDropDownAssignmentSetupCR;
	...
	WebElement ClickSelectTextTemplateDropDownAssignmentSetupCR;
	...
	@FindBy(xpath = "(//span[@class='ng-arrow-wrapper'])")
	WebElement DefaultContactOwnerDropDownforLPWRDropDown;
	
	@FindBy(xpath = "(//div[@title='Drag to add new'])[4]")
	...
	public void ClickSelectEmailTemplateDropDownAssignmentSetupCR() {
		new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(ClickSelectEmailTemplateDropDownAssignmentSetupCR));
		ClickSelectEmailTemplateDropDownAssignmentSetupCR.click();
	}
	...
	public void ClickSelectSlackTemplateDropDownAssignmentSetupCR() {
		new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(ClickSelectSlackTemplateDropDownAssignmentSetupCR));
		ClickSelectSlackTemplateDropDownAssignmentSetupCR.click();
	}
	...
	public void ClickSelectTextTemplateDropDownAssignmentSetupCR() {
		new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(ClickSelectTextTemplateDropDownAssignmentSetupCR));
		ClickSelectTextTemplateDropDownAssignmentSetupCR.click();
	}
...
//	}
	...
	public void DefaultContactOwnerDropDownforLPWRDropDown() {
		new WebDriverWait(ldriver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(DefaultContactOwnerDropDownforLPWRDropDown));
		DefaultContactOwnerDropDownforLPWRDropDown.click();
	}
	...
	//***********************OTS Details page****************
		...
		@FindBy(xpath = "//span[text()='Start OTS when member of this is a filter']//..//..//..//..//ng-select[@bindlabel='SubMenuName']")
