...
public class LeadRoutingTerritoryPage {
	...
	@FindBy(xpath="//ng-select[@formcontrolname='TextBox1']")
	WebElement AccountListSecondSelectBoxDropdown;
...
//*********************************************************************************************************	
	...
	WebElement CRMAccFilterSelectOptionDropdownCR;
	...
	@FindBy(xpath="(//ng-select[@name='seldropDown'])[4]")
	WebElement SystemDataDictionarySelectOptionDropdownCR;
	@FindBy(xpath="(//mat-option[@role='option'])[2]")
...
//		actions.contextClick(RoundRobinTeam).perform();
	...
	public void AccountListSecondSelectBoxDropdown() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(AccountListSecondSelectBoxDropdown));
		AccountListSecondSelectBoxDropdown.click();
	}
...
//	}
	...
	public void CRMAccFilterSelectOptionDropdownCR() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(CRMAccFilterSelectOptionDropdownCR));
		CRMAccFilterSelectOptionDropdownCR.click();
	}
	...
	public void SystemDataDictionarySelectOptionDropdownCR() {
		new WebDriverWait(ldriver, Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(SystemDataDictionarySelectOptionDropdownCR));
		SystemDataDictionarySelectOptionDropdownCR.click();
	}
