...
@Test
public class TC_Sanity_ContactProcessingWithoutRouting_ContactManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_Sanity_ContactProcessingWithoutRouting_ContactManagement.class);
	public void ContactManagement() throws InterruptedException {
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnCreateTaskForTheNewSuggestedOwnerCheckBox();
			Logger.info("Click on CreateTaskForTheNewSuggestedOwner CheckBox is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on CreateTaskForTheNewSuggestedOwner CheckBox is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2600);
		try {
		...
		try {
			...
			Logger.info("Click on CreateTaskForTheNewSuggestedOwner DropDown is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on CreateTaskForTheNewSuggestedOwner DropDown is Failed !!", e);
			sa.assertAll();
		}
		...
		Thread.sleep(3500);
		try {
			CM.ClickOnContactProcessingWithoutRouting();
			Logger.info("Click On ContactProcessingWithoutRouting Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on ContactProcessingWithoutRouting Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if(CM.ContactProcessingWithoutRoutingOverview()==true) {
				Logger.info("Display ContactProcessingWithoutRouting OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display ContactProcessingWithoutRouting OverView Page is Failed", e);
			sa.assertAll();
		}
