...
public class TC_CrudOperation_WaitCondition_ContactManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_CrudOperation_WaitCondition_ContactManagement.class);
	public void crud_AccountList() throws InterruptedException {
		...
		if(ae.DisplaySameAEerror() == true) {
			...
			try {
				...
				Logger.info("Click WaitCondition DropDown is PASSED!!");
			} catch (Exception e) {
				sa.assertTrue(false);
				Logger.error("Click WaitCondition DropDown is is FAILED!", e);
				sa.assertAll();
			}
			Thread.sleep(2500);
			try {
		...
		Logger.info("//*************************************** Make Use of this Object in Contact Router *******************************************");
		Thread.sleep(3500);
		try {
		...
		try {
			...
			Logger.info("Displayed Input Box is red,Enter again WaitFor data");
			Thread.sleep(500);
			LMP.InputWaitFor();
			Logger.info("Input on WaitFor is PASSED!!");
			Thread.sleep(500);
		...
		try {
			...
			Logger.info("Displayed Select Box is red,Select again WaitFor Minutes option");
			Thread.sleep(500);
			LMP.ClickOnWaitForMinutes();
			Logger.info("Click on WaitForMinutes is PASSED!!");
			Thread.sleep(500);
