...
@Test
public class TC_Sanity_ContactRouter_ContactManagement extends BaseClass{
	private static final Logger Logger = LogManager.getLogger(TC_Sanity_ContactRouter_ContactManagement.class);
	public void ContactManagement() throws InterruptedException {
		...
		try {
			...
			sa.assertTrue(false);
			Logger.error("Click on New ContactRouter is Failed",e);
			sa.assertAll();
		}
		...
		try {
			...
			Logger.info("Connect RandomSlitC_To_UpdateDataValue is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Connect RandomSlitC_To_UpdateDataValue is Failed!!!!", e);
			sa.assertAll();
		}
		Thread.sleep(4000);
		try {
		...
		for (int i = 1; i <=count; i++) {
			...
			if(i==1||i==2||i==3)
			{
				if (i==1) {
					Thread.sleep(1500);
					try {
						LPWR.SelectOtherLatitudeForUpdateDataValue();
						Logger.info("Select OtherLatitude is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select OtherLatitude is Failed !!",e);
						sa.assertAll();
					}	
				}	
				else if (i==2) {
					...
					try {
						...
						Logger.info("Select AccountID is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select AccountID is Failed !!",e);
						sa.assertAll();
					}	
				}	
				else if (i==3) {
				...
				for (int j = 0; j <5; j++) {
					...
					if (getLinkTextSecondListBox.contains("Set to (Text/Number/Date)")==true) {
						...
						if (i==1) {
							try {
								...
								Logger.info("Enter Number For Other Latitude is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Enter Number For Other Latitude is Failed !!",e);
								sa.assertAll();
							}
							Thread.sleep(2500);
							try {
					...
					else if (getLinkTextSecondListBox.contentEquals("Lookup with Contact")==true || getLinkTextSecondListBox.contentEquals("Lookup with Account")==true ||
							getLinkTextSecondListBox.contains("Lookup with Contact Owner")==true) {
						for (int k = 0; k <1; k++) {
							Thread.sleep(2000);
							try {
						...
						for (int M = 1; M <= 3; M++) {
							...
							if (M==2) {
								Thread.sleep(1500);
								try {
									LPWR.SelectContactInObjectDropDownUpdateDataValue();
									Logger.info("Select Contact In Object DropDown is Passed");
								} catch (Exception e) {
									sa.assertTrue(false);
									Logger.error("Select Contact In Object DropDown is Failed", e);
									sa.assertAll();
								}
							}
							if (M==3) {
								Thread.sleep(1500);
								try {
									LPWR.SelectContactOwnerInObjectDropDownUpdateDataValue();
									Logger.info("Select Contact Owner In Object DropDown is Passed");
								} catch (Exception e) {
									sa.assertTrue(false);
									Logger.error("Select Contact Owner In Object DropDown is Failed", e);
									sa.assertAll();
								}
							}
							Thread.sleep(1500);
		...
		try {
			...
			Logger.info("Click CreateTaskForTheNewOwner CheckBox is Passed !!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click CreateTaskForTheNewOwner CheckBox is Failed !!", e);
			sa.assertAll();
		}
		Thread.sleep(2600);
		try {
		...
		for (int i = 1; i < CountAllLinks; i++) {//CountAllLinks
			...
			if (getLinkTextAssignmentFirstListBox.contains("Assign Based on a Lookup Field in the Parent Account")==true) {
				...
				if (getLinkTextAssignmentFirstListBox.contains("Assign Based on a Lookup Field in the Parent Account")==true) {//Add Data Update
					...
					for (int j = 0; j <3; j++) {//j3
						...
						else if (j==2) {//Otherlattitude
							Thread.sleep(1500);
							try {
								LPWR.LatitudeOrCreatedDateDropDownForAddDataUpdateButton();
								Logger.info("OtherLatitude DropDown For AddDataUpdateButton is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("OtherLatitude DropDown For AddDataUpdateButton is Failed !!", e);
								sa.assertAll();
							}
							Thread.sleep(1500);
							try {
								LPWR.ClickOnOtherLatitudeOptionForAddDataUpdate();
								Logger.info("Click On Other Latitude Option For AddDataUpdate is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Click On Other Latitude Option For AddDataUpdate is Failed !!", e);
								sa.assertAll();
							}
							Thread.sleep(1500);
							try {
								LPWR.EnterNumberForLatitudeUpdateDataValue();
								Logger.info("Enter Number For OtherLatitude UpdateDataValue is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Enter Number For OtherLatitude UpdateDataValue is Failed !!",e);
								sa.assertAll();
							}
							Thread.sleep(2500);
							try {
			...
			else if (getLinkTextAssignmentFirstListBox.contains("Assign to Parent Accounts Owner")==true||
					getLinkTextAssignmentFirstListBox.contains("Assign to Sales Team")==true||
				...
				if (getLinkTextAssignmentFirstListBox.contains("Assign to Parent Accounts Owner")==true) {
					...
					Thread.sleep(2000);
					try {
						LPWR.ClickIfNoOneIsAvailableHoldTheContactCheckBox();
						Logger.info("Click IfNoOneIsAvailableHoldTheContact CheckBox is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Click IfNoOneIsAvailableHoldTheContact CheckBox is Failed !!", e);
						sa.assertAll();
					}
				}
					...
					getLinkTextAssignmentFirstListBox.contains("Assign to Sales Rep Email Lookup on Contact")==true||
					getLinkTextAssignmentFirstListBox.contains("Assign to Sales Rep ID Lookup on Contact")==true||
		...
		try {
			...
			Logger.info("Click On Contact Router Feeder DropDown is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Contact Router Feeder DropDown is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.SelectSuggestedNewOwnerOption();
			Logger.info("Select Contact Router Feeder Option is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select Contact Router Feeder Option is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.CheckBoxForSuggestedNewOwner();
			Logger.info("Check Box For Contact Router Feeder is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Check Box For Contact Router Feeder is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(800);
		try {
		...
		try {
			...
			Logger.info("Data value update when routed to Default Contact Owner AddButton is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Data value update when routed to Default Contact Owner AddButton is Failed!!", e);
			sa.assertAll();
		}
		...
		for (int D = 0; D < 4; D++) {//D
			...
			try {
				...
				Logger.info("Data value update when routed to Default Contact Owner DropDown1 is Passed!!");
			} catch (Exception e) {
				sa.assertTrue(false);
				Logger.error("Data value update when routed to Default Contact Owner DropDown1 is Failed!!", e);
				sa.assertAll();
			}
				...
				for (int k = 0; k <4; k++) {//k4
					...
					if (k==0) {
						...
						try {
							...
							sa.assertTrue(false);
							Logger.error("Click on CheckBox For DataValueUpdateWhenRoutedToDefaultContactOwner Failed!!", e);
							sa.assertAll();
						}
						Thread.sleep(900);
						try {
			...
			else if (D==2) {//Other lattitude
				try {
					Thread.sleep(1500);
					LPWR.ClickOnOtherLatitudeOptionDetailsPage();
					Logger.info("Click On OtherLatitude Option Details Page is Passed !!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Click On OtherLatitude option Details page is Failed !!",e);
					sa.assertAll();
				}
				Thread.sleep(1500);
				try {
					LPWR.EnterNumberForLatitudeUpdateDataValue();
					Logger.info("Enter Number For OtherLatitude Details Page is Passed !!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Enter Number For OtherLatitude Details Page is Failed !!",e);
					sa.assertAll();
				}
				Thread.sleep(2500);
				try {
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnContactRouterFeature();
			Logger.info("Click On Contact Router Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Contact Router Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if(CM.ContactRouterOverview()==true) {
				Logger.info("Display ContactRouter OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display ContactRouter OverView Page is Failed", e);
			sa.assertAll();
		}
