...
public class TC_Sanity_AccountRouter_AccountManagement extends BaseClass{
	...
	public void AccountManagementTest() throws InterruptedException {
		...
		Thread.sleep(2500);
		try {
			LR.ClickOnContinueProcessingCheckBoxAR();
		...
		Thread.sleep(3000);
		try {
			LR.ClickOnStopProcessingCheckBoxAR();
		...
		for (int i = 1; i <=count; i++) {
			...
			if(i==1||i==2||i==3)
			{
				if (i==1) {
					Thread.sleep(1500);
					try {
						LPWR.SelectBillingLatitudeForUpdateDataValue();
						Logger.info("Select BillingLatitude is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select BillingLatitude is Failed !!",e);
						sa.assertAll();
					}	
				}	
				else if (i==2) {
					Thread.sleep(1500);
					try {
						LPWR.SelectAccountNameForUpdateDataValue();
						Logger.info("Select AccountName is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select AccountName is Failed !!",e);
						sa.assertAll();
					}	
				}	
				else if (i==3) {
					...
					try {
						...
						Logger.info("Select CreatedDate is Passed !!");
					} catch (Exception e) {
						sa.assertTrue(false);
						Logger.error("Select CreatedDate is Failed !!",e);
						sa.assertAll();
					}
				}
				...
				for (int j = 0; j <4; j++) {
					...
					if (getLinkTextSecondListBox.contains("Set to (Text/Number/Date)")==true) {
						...
						if (i==1) {
							try {
								...
								Logger.info("Enter Number For Billing Latitude is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Enter Number For Billing Latitude is Failed !!",e);
								sa.assertAll();
							}
							...
							try {
								...
								Logger.info("Enter Number For AccountName is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Enter Number For AccountName is Failed !!",e);
								sa.assertAll();
							}
					...
					else if (getLinkTextSecondListBox.contains("Lookup with Account")==true  ||
							getLinkTextSecondListBox.contains("Lookup with Account Owner")==true) {
						for (int k = 0; k <2; k++) {
							Thread.sleep(2500);
							try {
								LR.SelectThirdListBoxdropdownForUpdateDataValueAR();
						...
						for (int M = 1; M <= 3; M++) {
							...
							if (M==3) {
								...
								try {
									...
									Logger.info("Select Account Owner In Object DropDown is Passed");
								} catch (Exception e) {
									sa.assertTrue(false);
									Logger.error("Select Account Owner In Object DropDown is Failed", e);
									sa.assertAll();
								}
							}
							Thread.sleep(1500);
				...
				try {
					...
					Logger.info("Select 'Deleted' Option is Passed !!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Select 'Deleted' Option is Failed !!",e);
					sa.assertAll();
				}
				Thread.sleep(1500);
				try {
		...
		for (int i = 1; i < CountAllLinks; i++) {//CountAllLinks
			...
			if (getLinkTextAssignmentFirstListBox.contains("Assign to Sales Team")==true||
					getLinkTextAssignmentFirstListBox.contains("Assign to Weighted Sales Team")==true) {//Assign sales rep
				...
				Thread.sleep(2500);
				if (getLinkTextAssignmentFirstListBox.contains("Assign to Weighted Sales Team")==true) {
					Thread.sleep(2500);
					try {
					...
					getLinkTextAssignmentFirstListBox.contains("Assign to Sales Rep ID Lookup on Account")==true) {//Assign to sales Rep
				Thread.sleep(2000);
				try {
					LPWR.SelectDropDownForAssignToQueue();
					Logger.info("Click on main second Select DropDown is Passed");
				...
				if (getLinkTextAssignmentFirstListBox.contentEquals("Assign to Sales Rep")==true) {
					Thread.sleep(1500);
					try {
				...
				if (getLinkTextAssignmentFirstListBox.contentEquals("Assign to Sales Rep")==true) {//Add Data Update
					...
					for (int j = 0; j <3; j++) {//j3
						...
						if (j==0) {//j0
							Thread.sleep(3000);
							try {
								LPWR.WebsiteDropDownForAddDataUpdateButton();
								Logger.info("Website DropDown For AddDataUpdateButton is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Website DropDown For AddDataUpdateButton is Failed !!", e);
								sa.assertAll();
							}
							Thread.sleep(3000);
							try {
								LPWR.ClickOnWebsiteOptionForAddDataUpdate();
								Logger.info("Click On Website Option For AddDataUpdate is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Click On Website Option For AddDataUpdate is Failed !!", e);
								sa.assertAll();
							}
						...
						else if (j==2) {//Billing lattitude
							Thread.sleep(1500);
							try {
								LPWR.LatitudeOrCreatedDateDropDownForAddDataUpdateButton();
								Logger.info("BillingLatitude DropDown For AddDataUpdateButton is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("BillingLatitude DropDown For AddDataUpdateButton is Failed !!", e);
								sa.assertAll();
							}
							Thread.sleep(1500);
							try {
								LPWR.ClickOnBillingLatitudeOptionForAddDataUpdate();
								Logger.info("Click On Billing Latitude Option For AddDataUpdate is Passed !!");
							} catch (Exception e) {
								sa.assertTrue(false);
								Logger.error("Click On Billing Latitude Option For AddDataUpdate is Failed !!", e);
								sa.assertAll();
							}
							Thread.sleep(1500);
							try {
		...
		//			Logger.info("Click On Account Router Feeder DropDown is Passed!!");
		//		} catch (Exception e) {
		//			sa.assertTrue(false);
		//			Logger.error("Click On Account Router Feeder DropDown is Failed!!", e);
		//			sa.assertAll();
		//		}
		//		Thread.sleep(2500);
		//		try {
		//			detrrt.SelectSuggestedNewOwnerOption();
		//			Logger.info("Select Account Router Feeder Option is Passed!!");
		//		} catch (Exception e) {
		//			sa.assertTrue(false);
		//			Logger.error("Select Account Router Feeder Option is Failed!!", e);
		//			sa.assertAll();
		//		}
		//		Thread.sleep(2500);
		//		try {
		//			detrrt.CheckBoxForSuggestedNewOwner();
		//			Logger.info("Check Box For Account Router Feeder is Passed!!");
		//		} catch (Exception e) {
		//			sa.assertTrue(false);
		//			Logger.error("Check Box For Account Router Feeder is Failed!!", e);
		//			sa.assertAll();
		//		}
		//		Thread.sleep(900);
		//		try {
		//			detrrt.DisplaySuccessForSuggestedNewOwner();
		//			Logger.info("Display Success For Account Router Feeder is Passed!!");
		//		} catch (Exception e) {
		//			sa.assertTrue(false);
		//			Logger.error("Display Success For Account Router Feeder is Failed!!", e);
		//			sa.assertAll();
		//		}
		Thread.sleep(3500);
		try {
			detrrt.LeadProcessingFeederFilterDropDown();
			Logger.info("Click On Default Account Owner DropDown is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On Default Account Owner DropDown is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.SelectLeadProcessingFeederFilterOption();
			Logger.info("Select Default Account Owner Option is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Select Default Account Owner Option is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			detrrt.CheckBoxForLeadProcessingFeederFilter();
			Logger.info("CheckBox For Default Account Owner is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("CheckBox For Default Account Owner is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(900);
		try {
			detrrt.DisplaySuccessForLeadProcessingFeederFilter();
			Logger.info("Display Success For Default Account Owner is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display Success For Default Account Owner is Failed!!", e);
			sa.assertAll();
		}
		Thread.sleep(3100);
		try {
			detrrt.DataValueUpdateWhenRoutedToDefaultLeadOwnerAddButton();
			Logger.info("Data value update when routed to Default Account Owner AddButton is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Data value update when routed to Default Account Owner AddButton is Failed!!", e);
			sa.assertAll();
		}
		...
		for (int D = 0; D < 4; D++) {//D
			...
			try {
				...
				Logger.info("Data value update when routed to Default Account Owner DropDown1 is Passed!!");
			} catch (Exception e) {
				sa.assertTrue(false);
				Logger.error("Data value update when routed to Default Account Owner DropDown1 is Failed!!", e);
				sa.assertAll();
			}
			...
			if (D==0) {//j0
				...
				for (int k = 0; k <4; k++) {//k4
					...
					if (k==0) {
						...
						try {
							LPWR.SelectSetToTextForAddDataUpdateButton();
							Logger.info("Select SetToText Option For Data value update in Details page is Passed !!");
						} catch (Exception e) {
							sa.assertTrue(false);
							Logger.error("Select SetToText Option For Data value update in Details page is Failed !!", e);
							sa.assertAll();
						}
						Thread.sleep(1500);
						try {
			...
			else if (D==2) {//Billing lattitude
				try {
					Thread.sleep(1500);
					LPWR.ClickOnBillingLatitudeOptionDetailsPage();
					Logger.info("Click On BillingLatitude Option Details Page is Passed !!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Click On BillingLatitude option Details page is Failed !!",e);
					sa.assertAll();
				}
				Thread.sleep(1500);
				try {
					LPWR.EnterNumberForLatitudeUpdateDataValue();
					Logger.info("Enter Number For BillingLatitude Details Page is Passed !!");
				} catch (Exception e) {
					sa.assertTrue(false);
					Logger.error("Enter Number For BillingLatitude Details Page is Failed !!",e);
					sa.assertAll();
				}
				Thread.sleep(2500);
				try {
		...
		Thread.sleep(3500);
		try {
			LR.ClickOnAccountRouterFeature();
			Logger.info("Click On Account Router Feature is Passed");
		}catch(Exception e) {
			sa.assertTrue(false);
			Logger.error("Click on Account Router Feature is FAILED!!", e);
			sa.assertAll();
		}
		Thread.sleep(2500);
		try {
			if(AM.AccountRouterOverview()==true) {
				Logger.info("Display AccountRouter OverView Page is Passed");
			}
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Display AccountRouter OverView Page is Failed", e);
			sa.assertAll();
		}
