...
public class TC_CrudOperation_WaitCondition_AccountManagement extends BaseClass {
	...
	public void LeadManagementTest() throws InterruptedException {
		...
		try {
			...
			Logger.info("Click On WaitTll Option is Passed!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On WaitTll Option is Failed!!!", e);
			sa.assertAll();
		}		
		Thread.sleep(2500);
		try {
			AM.clickOnWaitTillvalueDropDown();
			Logger.info("Click On WaitTillvalue DropDown is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On WaitTillvalue DropDown is FAILED!!!", e);
			sa.assertAll();
		}		
		Thread.sleep(2500);
		try {
			AM.clickOnWaitTillvalueOption();
			Logger.info("Click On WaitTillvalue Option is PASSED!!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Click On WaitTillvalue Option is FAILED!!!", e);
			sa.assertAll();
		}		  		  		  			  		  
		...
		try {
			...
			sa.assertTrue(false);
			Logger.error("Click on again Approve button is FAILED!",e);
			sa.assertAll();
		}
		Thread.sleep(3500);
		try {
		...
		Logger.info("//*************************************** Make Use of this Object in Account Router *******************************************");
		Thread.sleep(3500);
		try {
		...
		try {
			rrp.DisplayApproved();
			Logger.info("Displayed Approve button is PASSED!");
		} catch (Exception e) {
			sa.assertTrue(false);
			Logger.error("Displayed Approve button is FAILED!!",e);
			sa.assertAll();
		}
