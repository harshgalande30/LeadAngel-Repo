...
public class LeadManagementPage {
	...
	@FindBy(xpath="//button[@aria-label='toggle a[sdfdg']")
	WebElement AccountListAccountManagementFolder;
	...
	WebElement CRMAccFilterAccMgmtFolderToMove;
	...
	@FindBy(xpath="(//mat-icon[text()=' chevron_right '])[5]")
	WebElement WaitConditionFolderDisplayExpand;
	...
	@FindBy(xpath="//ng-select[@placeholder='Select Wait Filter']")
	...
	public void NameInObject() {
		...
		txtNameObject.sendKeys("Automation");
	...
	public void clickOnSelectWaitFilterDropDown() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(clickOnSelectWaitFilterDropDown));
		clickOnSelectWaitFilterDropDown.click();
	}
	public void SelectWaitFilterOption() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(SelectWaitFilterOption));
		SelectWaitFilterOption.click();
	}
	...
	public void AccountListAccountManagementFolder() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(AccountListAccountManagementFolder));
		AccountListAccountManagementFolder.click();
	}
	...
	public void CRMAccFilterAccMgmtFolderToMove() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.elementToBeClickable(CRMAccFilterAccMgmtFolderToMove));
		CRMAccFilterAccMgmtFolderToMove.click();
	}
	...
	public boolean WaitConditionFolderDisplayExpand() {
		new WebDriverWait(ldriver, Duration.ofSeconds(25)).until(ExpectedConditions.visibilityOf(WaitConditionFolderDisplayExpand));
		return WaitConditionFolderDisplayExpand.isDisplayed();
	}
	...
	public void RightClickOnLeadRouter() {
		...
		Actions actions = new Actions(ldriver);
		actions.moveToElement(LeadRouter).click(LeadRouter).contextClick(LeadRouter).build().perform();
	...
	WebElement DisplayDeleteSuccessMsg;
	@FindBy(xpath = "(//div[contains(text(),'Can not delete')])[2]")
	WebElement DisplayDeleteErrorMsg;

	public boolean DisplayDeleteSuccessMsg() {
		//new WebDriverWait(ldriver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOf(DisplayDeleteSuccessMsg));
		return DisplayDeleteSuccessMsg.isDisplayed();
	}
	public boolean DisplayDeleteErrorMsg() {
		//new WebDriverWait(ldriver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOf(DisplayDeleteErrorMsg));
		return DisplayDeleteErrorMsg.isDisplayed();
	}
	public void InputOnRenamerandomly() {
		new WebDriverWait(ldriver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOf(InputRename_AutoTestObject));
		InputRename_AutoTestObject.clear();
		InputRename_AutoTestObject.sendKeys("ABCD");
	}
	
	//**********************************Sanity Account router X path************************************
