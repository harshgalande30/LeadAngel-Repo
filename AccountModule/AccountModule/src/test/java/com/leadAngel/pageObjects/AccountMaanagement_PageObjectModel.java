...
public class AccountMaanagement_PageObjectModel {
	...
	//************************************************** Account Routing Territory ********************************************
		...
		@FindBy(xpath = "//i[@class='righticon-NUMBER']//..//span[text()='Billing Latitude']")
		...
		public void RightClickOnAccountRouter() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(AccountRouter).contextClick(AccountRouter).build()
			.perform();
		}
		...
		public void RightClickOnAccountRoutingTerritory() {
			...
			Actions actions = new Actions(ldriver);
			actions.moveToElement(AccountRoutingTerritory).contextClick(AccountRoutingTerritory).build()
			.perform();
		}
