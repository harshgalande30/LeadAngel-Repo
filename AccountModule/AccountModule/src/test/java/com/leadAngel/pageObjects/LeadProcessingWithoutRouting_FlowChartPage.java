...
public class LeadProcessingWithoutRouting_FlowChartPage {
	...
	//************************************************************* Sanity Test Cases *****************************************************************
		...
		@FindBy(xpath = "//span[text()='Billing Latitude']")
		WebElement ClickOnBillingLatitudeOptionForAddDataUpdate;
		@FindBy(xpath = "//span[text()='Deleted']")
		WebElement ClickOnDeletedOptionForAddDataUpdate;
		@FindBy(xpath = "//span[text()='Website']")
		WebElement ClickOnWebsiteOptionForAddDataUpdate;
		...
		WebElement WebsiteDropDownForAddDataUpdateButton;
		...
		public void WebsiteDropDownForAddDataUpdateButton(){
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(WebsiteDropDownForAddDataUpdateButton));
			WebsiteDropDownForAddDataUpdateButton.click(); 
		}
		...
		public void ClickOnBillingLatitudeOptionForAddDataUpdate() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnBillingLatitudeOptionForAddDataUpdate));
			ClickOnBillingLatitudeOptionForAddDataUpdate.click();
		}
		...
		public void ClickOnWebsiteOptionForAddDataUpdate() {
			new WebDriverWait(ldriver, Duration.ofSeconds(20)).until(ExpectedConditions.elementToBeClickable(ClickOnWebsiteOptionForAddDataUpdate));
			ClickOnWebsiteOptionForAddDataUpdate.click();
		}
